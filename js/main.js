(function($) {
    ...
    $window.on('scroll', function() {
        ...
        if (scroll <= 50) {
            ...
            logoinner.attr('src', 'https://badaengineering.com/assest/image/logo.png');
            logodefault.attr('src', 'https://badaengineering.com/assest/image/logo.png');
            logowhite.attr('src', 'img/logo-white.png');
            logowhitedark.attr('src', 'img/logo-white.png');
            logo2.attr('src', 'img/logo-2-light.png');
            logo3.attr('src', 'img/logo-2-dark.png');
        } else {
            $("header").removeClass("fixedHeader").addClass("scrollHeader");
            logoinner.attr('src', 'https://badaengineering.com/assest/image/logo.png');
            logodefault.attr('src', 'https://badaengineering.com/assest/image/logo.png');
            logowhite.attr('src', 'img/logo-white.png');
            logowhitedark.attr('src', 'img/logo-dark.png');
            logo2.attr('src', 'img/logo-2-dark.png');
            logo3.attr('src', 'img/logo-2-dark.png');
        }
    });
    $window.on('scroll', function() {
