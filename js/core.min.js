!function(t, e) {
    ...
    S.extend = S.fn.extend = function() {
        ...
        s--); s < l; s++)
            if (null != (t = arguments[s]))
                for (e in t)
                    n = t[e],
                    "__proto__" !== e && a !== n && (c && n && (S.isPlainObject(n) || (o = Array.isArray(n))) ? (i = a[e],
                    r = o && !Array.isArray(i) ? [] : o || S.isPlainObject(i) ? i : {},
                    o = !1,
                    a[e] = S.extend(c, r, n)) : void 0 !== n && (a[e] = n));
        return a
    }
    ,
    S.extend({
        ...
        makeArray: function(t, e) {
            var i = e || [];
            return null != t && (d(Object(t)) ? S.merge(i, "string" == typeof t ? [t] : t) : l.call(i, t)),
            i
        },
    ...
    var f = function(i) {
        ...
        var t, f, x, r, a, p, d, g, w, l, c, _, C, s, k, m, u, v, y, S = "sizzle" + +new Date, b = i.document, T = 0, n = 0, E = lt(), I = lt(), A = lt(), D = lt(), M = function(t, e) {
            return t === e && (c = !0),
            0
        }, P = {}.hasOwnProperty, e = [], O = e.pop, L = e.push, F = e.push, z = e.slice, N = function(t, e) {
            for (var i = 0, n = t.length; i < n; i++)
                if (t[i] === e)
                    return i;
            return -1
        }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", j = "[\\x20\\t\\r\\n\\f]", W = "(?:\\\\[\\da-fA-F]{1,6}" + j + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", B = "\\[" + j + "*(" + W + ")(?:" + j + "*([*^$|!~]?=)" + j + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + W + "))|)" + j + "*\\]", H = ":(" + W + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + B + ")*)|.*)\\)|)", q = new RegExp(j + "+","g"), V = new RegExp("^" + j + "+|((?:^|[^\\\\])(?:\\\\.)*)" + j + "+$","g"), $ = new RegExp("^" + j + "*," + j + "*"), U = new RegExp("^" + j + "*([>+~]|" + j + ")" + j + "*"), Q = new RegExp(j + "|>"), Y = new RegExp(H), X = new RegExp("^" + W + "$"), G = {
            ID: new RegExp("^#(" + W + ")"),
            CLASS: new RegExp("^\\.(" + W + ")"),
            TAG: new RegExp("^(" + W + "|[*])"),
            ATTR: new RegExp("^" + B),
        ...
        }, K = /HTML$/i, Z = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, tt = /^[^{]+\{\s*\[native \w/, et = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, it = /[+~]/, nt = new RegExp("\\\\[\\da-fA-F]{1,6}" + j + "?|\\\\([^\\r\\n\\f])","g"), ot = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, rt = function(t, e) {
        ...
        try {
            F.apply(e = z.call(b.childNodes), b.childNodes),
        ...
        function st(t, e, i, n) {
            var o, r, a, s, l, c, u, h = e && e.ownerDocument, d = e ? e.nodeType : 9;
            if (i = i || [],
            ...
            k)) {
                    ...
                    if (o = l[1]) {
                        if (9 === d) {
                            ...
                            if (a.id === o)
                                return i.push(a),
                                i
                        } else if (h && (a = h.getElementById(o)) && y(e, a) && a.id === o)
                            return i.push(a),
                            i
                    } else {
                        if (l[2])
                ...
                if (f.qsa && !D[t + " "] && (!m || !m.test(t)) && (1 !== d || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t,
                    h = e,
                    1 === d && (Q.test(t) || U.test(t))) {
                        for ((h = it.test(t) && vt(e.parentNode) || e) === e && f.scope || ((s = e.getAttribute("id")) ? s = s.replace(ot, rt) : e.setAttribute("id", s = S)),
                        r = (c = p(t)).length; r--; )
                            c[r] = (s ? "#" + s : ":scope") + " " + bt(c[r]);
                        u = c.join(",")
                    }
                    try {
                        return F.apply(i, h.querySelectorAll(u)),
                        i
                    } catch (e) {
                        D(t, !0)
                    } finally {
        ...
        function mt(a) {
            return ct(function(r) {
                return r = +r,
                ct(function(t, e) {
                    for (var i, n = a([], t.length, r), o = n.length; o--; )
                        t[i = n[o]] && (t[i] = !(e[i] = t[i]))
                })
            })
        }
        ...
        _ = st.setDocument = function(t) {
            ...
            return n != C && 9 === n.nodeType && n.documentElement && (s = (C = n).documentElement,
            k = !a(C),
            ...
            u = [],
            m = [],
            (f.qsa = tt.test(C.querySelectorAll)) && (ut(function(t) {
                var e;
            ...
            y = e || tt.test(s.contains) ? function(t, e) {
            ...
            : function(t, e) {
                ...
                if (!o || !r)
                    return t == C ? -1 : e == C ? 1 : o ? -1 : r ? 1 : l ? N(l, t) - N(l, e) : 0;
                if (o === r)
                    return dt(t, e);
        ...
        st.matchesSelector = function(t, e) {
            if (_(t),
            f.matchesSelector && k && !D[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e)))
                try {
                    var i = v.call(t, e);
        ...
        (x = st.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return G.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && Y.test(i) && (e = p(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e),
                    t[2] = i.slice(0, e)),
                    t.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(i, n, o) {
                    return function(t) {
                        var e = st.attr(t, i);
                        return null == e ? "!=" === n : !n || (e += "",
                        "=" === n ? e === o : "!=" === n ? e !== o : "^=" === n ? o && 0 === e.indexOf(o) : "*=" === n ? o && -1 < e.indexOf(o) : "$=" === n ? o && e.slice(-o.length) === o : "~=" === n ? -1 < (" " + e.replace(q, " ") + " ").indexOf(o) : "|=" === n && (e === o || e.slice(0, o.length + 1) === o + "-"))
                    }
                },
                CHILD: function(p, t, e, g, m) {
                    ...
                    : function(t, e, i) {
                        var n, o, r, a, s, l, c = v != y ? "nextSibling" : "previousSibling", u = t.parentNode, h = b && t.nodeName.toLowerCase(), d = !i && !b, f = !1;
                        if (u) {
                            if (v) {
                                for (; c; ) {
                                    for (a = t; a = a[c]; )
                            ...
                            y && d) {
                                for (f = (s = (n = (o = (r = (a = u)[S] || (a[S] = {}))[a.uniqueID] || (r[a.uniqueID] = {}))[p] || [])[0] === T && n[1]) && n[2],
                                a = s && u.childNodes[s]; a = ++s && a && a[c] || (f = s = 0) || l.pop(); )
                                    if (1 === a.nodeType && ++f && a === t) {
                                        o[p] = [T, s, f];
                                        break
                                    }
                            } else if (d && (f = s = (n = (o = (r = (a = t)[S] || (a[S] = {}))[a.uniqueID] || (r[a.uniqueID] = {}))[p] || [])[0] === T && n[1]),
                            !1 === f)
                                for (; (a = ++s && a && a[c] || (f = s = 0) || l.pop()) && ((b ? a.nodeName.toLowerCase() !== h : 1 !== a.nodeType) || !++f || (d && ((o = (r = a[S] || (a[S] = {}))[a.uniqueID] || (r[a.uniqueID] = {}))[p] = [T, f]),
                                a !== t)); )
                                    ;
                ...
                PSEUDO: function(t, r) {
                    ...
                    return a[S] ? a(r) : 1 < a.length ? (e = [t, t, "", r],
                    x.setFilters.hasOwnProperty(t.toLowerCase()) ? ct(function(t, e) {
                        for (var i, n = a(t, r), o = n.length; o--; )
                            t[i = N(t, n[o])] = !(e[i] = n[o])
                    }) : function(t) {
                        return a(t, 0, e)
                    }
            ...
            pseudos: {
                ...
                lang: ct(function(i) {
                    return X.test(i || "") || st.error("unsupported lang: " + i),
        ...
        function xt(s, t, e) {
            ...
            : function(t, e, i) {
                ...
                if (i) {
                    for (; t = t[l]; )
                        if ((1 === t.nodeType || h) && s(t, e, i))
                            return !0
                } else
                    for (; t = t[l]; )
                        if (1 === t.nodeType || h)
                            if (o = (r = t[S] || (t[S] = {}))[t.uniqueID] || (r[t.uniqueID] = {}),
        ...
        function Ct(f, p, g, m, v, t) {
            ...
            v && !v[S] && (v = Ct(v, t)),
            ct(function(t, e, i, n) {
                var o, r, a, s = [], l = [], c = e.length, u = t || function(t, e, i) {
                    for (var n = 0, o = e.length; n < o; n++)
                        st(t, e[n], i);
                    return i
                }(p || "*", i.nodeType ? [i] : i, []), h = !f || !t && p ? u : _t(u, s, f, i, n), d = g ? v || (t ? f : c || m) ? [] : e : h;
                if (g && g(h, d, i, n),
                m)
                    for (o = _t(d, l),
                    m(o, [], i, n),
                ...
                if (t) {
                    if (v || f) {
                        ...
                        for (r = d.length; r--; )
                            (a = d[r]) && -1 < (o = v ? N(t, a) : s[r]) && (t[o] = !(e[o] = a))
                    }
                } else
                    d = _t(d === e ? d.splice(c, d.length) : d),
                    v ? v(null, e, d, n) : F.apply(e, d)
            })
        }
        function kt(t) {
        ...
        p = st.tokenize = function(t, e) {
            ...
            s = [],
            l = x.preFilter; a; ) {
                for (r in i && !(n = $.exec(a)) || (n && (a = a.slice(n[0].length) || a),
                s.push(o = [])),
                i = !1,
                ...
                a = a.slice(i.length)),
                x.filter)
                    !(n = G[r].exec(a)) || l[r] && !(n = l[r](n)) || (i = n.shift(),
                    o.push({
                        value: i,
                        type: r,
                        matches: n
        ...
        d = st.compile = function(t, e) {
            var i, m, v, y, b, n, o = [], r = [], a = A[t + " "];
            if (!a) {
                for (i = (e = e || p(t)).length; i--; )
                    (a = kt(e[i]))[S] ? o.push(a) : r.push(a);
                (a = A(t, (m = r,
                y = 0 < (v = o).length,
                b = 0 < m.length,
                n = function(t, e, i, n, o) {
                    var r, a, s, l = 0, c = "0", u = t && [], h = [], d = w, f = t || b && x.find.TAG("*", o), p = T += null == d ? 1 : Math.random() || .1, g = f.length;
                    for (o && (w = e == C || e || o); c !== g && null != (r = f[c]); c++) {
                        if (b && r) {
                            for (a = 0,
                            e || r.ownerDocument == C || (_(r),
                            i = !k); s = m[a++]; )
                                if (s(r, e || C, i)) {
                                    n.push(r);
                                    break
                    ...
                    y && c !== l) {
                        ...
                        if (t) {
                            if (0 < l)
                                for (; c--; )
                                    u[c] || h[c] || (h[c] = O.call(n));
                            h = _t(h)
                        }
                        F.apply(n, h),
                        o && !t && 0 < h.length && 1 < l + v.length && st.uniqueSort(n)
                    }
                    return o && (T = p,
                    w = d),
                    u
        ...
        g = st.select = function(t, e, i, n) {
            var o, r, a, s, l, c = "function" == typeof t && t, u = !n && p(t = c.selector || t);
            if (i = i || [],
            1 === u.length) {
                if (2 < (r = u[0] = u[0].slice(0)).length && "ID" === (a = r[0]).type && 9 === e.nodeType && k && x.relative[r[1].type]) {
                    if (!(e = (x.find.ID(a.matches[0].replace(nt, h), e) || [])[0]))
                        return i;
                    c && (e = e.parentNode),
                    t = t.slice(r.shift().value.length)
                }
                for (o = G.needsContext.test(t) ? 0 : r.length; o-- && (a = r[o],
                !x.relative[s = a.type]); )
            ...
            return (c || d(t, u))(n, e, !k, i, !e || it.test(t) && vt(e.parentNode) || e),
            i
        }
        ,
    ...
    S.filter = function(t, e, i) {
        var n = e[0];
        return i && (t = ":not(" + t + ")"),
        1 === e.length && 1 === n.nodeType ? S.find.matchesSelector(n, t) ? [n] : [] : S.find.matches(t, S.grep(e, function(t) {
            return 1 === t.nodeType
        }))
    }
    ,
    ...
    (S.fn.init = function(t, e, i) {
        ...
        "string" != typeof t)
            ...
            this.length = 1,
            this) : b(t) ? void 0 !== i.ready ? i.ready(t) : t(S) : S.makeArray(t, this);
        if (!(n = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : M.exec(t)) || !n[1] && e)
            return !e || e.jquery ? (e || i).find(t) : this.constructor(e).find(t);
        if (n[1]) {
            if (e = e instanceof S ? e[0] : e,
            S.merge(this, S.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : k, !0)),
    ...
    S.fn.extend({
        ...
        closest: function(t, e) {
            var i, n = 0, o = this.length, r = [], a = "string" != typeof t && S(t);
            if (!T.test(t))
                for (; n < o; n++)
    ...
    S.each({
        ...
        contents: function(t) {
            return null != t.contentDocument && n(t.contentDocument) ? t.contentDocument : (E(t, "template") && (t = t.content || t),
        ...
        S.fn[n] = function(t, e) {
            ...
            1 < this.length && (O[n] || S.uniqueSort(i),
            P.test(n) && i.reverse()),
            this.pushStack(i)
        }
    });
        ...
        function o() {
            ...
            e = r = !0; l.length; c = -1)
                for (t = l.shift(); ++c < s.length; )
                    !1 === s[c].apply(t[0], t[1]) && n.stopOnFalse && (c = s.length,
                    t = !1);
            n.memory || (t = !1),
            r = !1,
            a && (s = t ? [] : "")
        }
        var r, t, e, a, s = [], l = [], c = -1, u = {
            add: function() {
                return s && (t && !r && (c = s.length - 1,
                l.push(t)),
                function i(t) {
    ...
    S.extend({
                    ...
                    function c(o, r, a, s) {
                        return function() {
                            function t() {
                                var t, e;
                                if (!(o < l)) {
                                    if ((t = a.apply(i, n)) === r.promise())
                                        throw new TypeError("Thenable self-resolution");
                                    e = t && ("object" == typeof t || "function" == typeof t) && t.then,
                                    b(e) ? s ? e.call(t, c(l, r, z, s), c(l, r, N, s)) : (l++,
                                    e.call(t, c(l, r, z, s), c(l, r, N, s), c(l, r, z, r.notifyWith))) : (a !== z && (i = void 0,
                                    n = [t]),
                                    (s || r.resolveWith)(i, n))
                                }
                            }
                            ...
                            ;
                            o ? e() : (S.Deferred.getStackHook && (e.stackTrace = S.Deferred.getStackHook()),
                            C.setTimeout(e))
                        }
                    }
                    return S.Deferred(function(t) {
                        r[0][3].add(c(0, t, b(n) ? n : z, t.notifyWith)),
                        r[1][3].add(c(0, t, b(e) ? e : z)),
                        r[2][3].add(c(0, t, b(i) ? i : N))
                    }).promise()
                },
                promise: function(t) {
        ...
        when: function(t) {
            ...
            var i = arguments.length
              ...
              , r = s.call(arguments)
              , a = S.Deferred();
            if (i <= 1 && (R(t, a.done(e(n)).resolve, a.reject, !i),
            "pending" === a.state() || b(r[n] && r[n].then)))
                return a.then();
            for (; n--; )
                R(r[n], e(n), a.reject);
            return a.promise()
    ...
    S.fn.extend({
        data: function(i, t) {
            var e, n, o, r = this[0], a = r && r.attributes;
            if (void 0 !== i)
                return "object" == typeof i ? this.each(function() {
                    ...
                    var e;
                    if (r && void 0 === t)
                        return void 0 !== (e = G.get(r, i)) || void 0 !== (e = J(r, i)) ? e : void 0;
                    this.each(function() {
                        G.set(this, i, t)
                    })
            ...
            1 === r.nodeType && !X.get(r, "hasDataAttrs"))) {
                for (e = a.length; e--; )
                    a[e] && 0 === (n = a[e].name).indexOf("data-") && (n = U(n.slice(5)),
                    J(r, n, o[n]));
    ...
    S.fn.extend({
        queue: function(e, i) {
            ...
            e = "fx",
            t--),
            arguments.length < t ? S.queue(this[0], e) : void 0 === i ? this : this.each(function() {
        ...
        promise: function(t, e) {
            ...
            var n, o = 1, r = S.Deferred(), a = this, s = this.length;
            for ("string" != typeof t && (e = t,
            t = void 0),
            t = t || "fx"; s--; )
                (n = X.get(a[s], t + "queueHooks")) && n.empty && (o++,
                n.empty.add(i));
            return i(),
            r.promise(e)
        }
    ...
    function st(t, e, i, n) {
        ...
        , l = s(), c = i && i[3] || (S.cssNumber[e] ? "" : "px"), u = t.nodeType && (S.cssNumber[e] || "px" !== c && +l) && et.exec(S.css(t, e));
        if (u && u[3] !== c) {
            for (l /= 2,
            c = c || u[3],
            u = +l || 1; a--; )
    ...
    function ct(t, e) {
        for (var i, n, o, r, a, s, l = [], c = 0, u = t.length; c < u; c++)
            ...
            e ? ("none" === i && (l[c] = X.get(n, "display") || null,
            l[c] || (n.style.display = "")),
            "" === n.style.display && at(n) && (l[c] = (s = r = o = void 0,
            r = n.ownerDocument,
            a = n.nodeName,
            (s = lt[a]) || (o = r.body.appendChild(r.createElement(a)),
            s = S.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === s && (s = "block"),
            lt[a] = s)))) : "none" !== i && (l[c] = "none",
            X.set(n, "display", i)));
        for (c = 0; c < u; c++)
    ...
    var ut, ht = /^(?:checkbox|radio)$/i, dt = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, ft = /^$|^module$|\/(?:java|ecma)script/i, pt = k.createDocumentFragment().appendChild(k.createElement("div"));
        ...
        S.event.add(t, o, {
            ...
            handler: function(t) {
                ...
                if (1 & t.isTrigger && this[o]) {
                    if (n.length)
                        (S.event.special[o] || {}).delegateType && t.stopPropagation();
    ...
    S.event = {
        ...
        add: function(e, t, i, n, o) {
            ...
            if (Q(e))
                ...
                c = (t = (t || "").match(F) || [""]).length; c--; )
                    ...
                    h.setup && !1 !== h.setup.call(e, n, p, a) || e.addEventListener && e.addEventListener(f, a)),
            ...
            if (m && (l = m.events)) {
                for (c = (e = (e || "").match(F) || [""]).length; c--; )
                    ...
                    f) {
                        ...
                        a = r = d.length; r--; )
                            u = d[r],
                            !o && g !== u.origType || i && i.guid !== u.guid || s && !s.test(u.namespace) || n && n !== u.selector && ("**" !== n || !u.selector) || (d.splice(r, 1),
                            u.selector && d.delegateCount--,
                            h.remove && h.remove.call(t, u));
                        a && !d.length && (h.teardown && !1 !== h.teardown.call(t, p, m.handle) || S.removeEvent(t, f, m.handle),
                        delete l[f])
                    } else
                        for (f in l)
                            S.event.remove(t, f + e[c], i, n, !0);
                S.isEmptyObject(l) && X.remove(t, "handle events")
            }
        },
        dispatch: function(t) {
            var e, i, n, o, r, a, s = new Array(arguments.length), l = S.event.fix(t), c = (X.get(this, "events") || Object.create(null))[l.type] || [], u = S.event.special[l.type] || {};
            for (s[0] = l,
            e = 1; e < arguments.length; e++)
                s[e] = arguments[e];
            if (l.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, l)) {
                for (a = S.event.handlers.call(this, l, c),
                e = 0; (o = a[e++]) && !l.isPropagationStopped(); )
                    ...
                    i = 0; (r = o.handlers[i++]) && !l.isImmediatePropagationStopped(); )
                        ...
                        l.data = r.data,
                        void 0 !== (n = ((S.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, s)) && !1 === (l.result = n) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === t.type && 1 <= t.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== t.type || !0 !== c.disabled)) {
                        ...
                        a = {},
                        i = 0; i < l; i++)
                            void 0 === a[o = (n = e[i]).selector + " "] && (a[o] = n.needsContext ? -1 < S(o, this).index(c) : S.find(o, this, null, [c]).length),
                            a[o] && r.push(n);
                        r.length && s.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && E(e, "input") && Et(e, "click", Ct),
                    !1
                },
                trigger: function(t) {
                    var e = this || t;
                    return ht.test(e.type) && e.click && E(e, "input") && Et(e, "click"),
                    !0
                },
                _default: function(t) {
                    var e = t.target;
    ...
    S.each({
        ...
        S.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return i && (i === this || S.contains(this, i)) || (t.type = n.origType,
    ...
    function Ft(i, n, o, r) {
        n = m(n);
        var t, e, a, s, l, c, u = 0, h = i.length, d = h - 1, f = n[0], p = b(f);
        ...
        e || r)) {
            for (s = (a = S.map(mt(t, "script"), Pt)).length; u < h; u++)
                l = t,
                u !== d && (l = S.clone(l, !0, !0),
                s && S.merge(a, mt(l, "script"))),
                o.call(i[u], l, u);
            if (s)
                ...
                u = 0; u < s; u++)
                    l = a[u],
                    ft.test(l.type || "") && !X.access(l, "globalEval") && S.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? S._evalUrl && !l.noModule && S._evalUrl(l.src, {
    ...
    S.extend({
        ...
        clone: function(t, e, i) {
            var n, o, r, a, s, l, c, u = t.cloneNode(!0), h = ot(t);
            if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || S.isXMLDoc(t)))
                for (a = mt(u),
                n = 0,
                o = (r = mt(t)).length; n < o; n++)
                    s = r[n],
                    "input" === (c = (l = a[n]).nodeName.toLowerCase()) && ht.test(s.type) ? l.checked = s.checked : "input" !== c && "textarea" !== c || (l.defaultValue = s.defaultValue);
            if (e)
                if (i)
                    for (r = r || mt(t),
                    a = a || mt(u),
                    ...
                    Lt(t, u);
            return 0 < (a = mt(u, "script")).length && vt(a, !h && mt(t, "script")),
            u
        },
    ...
    S.fn.extend({
        ...
        empty: function() {
            for (var t, e = 0; null != (t = this[e]); e++)
                1 === t.nodeType && (S.cleanData(mt(t, !1)),
                t.textContent = "");
            return this
        },
        clone: function(t, e) {
        ...
        html: function(t) {
            return H(this, function(t) {
                ...
                if ("string" == typeof t && !It.test(t) && !gt[(dt.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i < n; i++)
                            1 === (e = this[i] || {}).nodeType && (S.cleanData(mt(e, !1)),
                            e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
        ...
        replaceWith: function() {
            ...
            return Ft(this, arguments, function(t) {
                ...
                S.inArray(this, i) < 0 && (S.cleanData(mt(this)),
    ...
    S.each({
        ...
        S.fn[t] = function(t) {
            for (var e, i = [], n = S(t), o = n.length - 1, r = 0; r <= o; r++)
    ...
    var Rt, jt, Wt, Bt, Ht, qt, Vt, $t, Ut = new RegExp("^(" + tt + ")(?!px)[a-z%]+$","i"), Qt = function(t) {
    ...
    function Xt(t, e, i) {
        ...
        return (i = i || Qt(t)) && ("" !== (a = i.getPropertyValue(e) || i[e]) || ot(t) || (a = S.style(t, e)),
        !y.pixelBoxStyles() && Ut.test(a) && Yt.test(e) && (n = s.width,
        o = s.minWidth,
        r = s.maxWidth,
    ...
    function Kt() {
        var t;
        $t && (Vt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",
    ...
    ($t = k.createElement("div")).style && ($t.style.backgroundClip = "content-box",
    ...
    S.extend(y, {
        ...
        reliableTrDimensions: function() {
            var t, e, i, n;
            return null == Ht && (t = k.createElement("table"),
    ...
    function le(t, e, i, n, o, r) {
        ...
        for (; a < 4; a += 2)
            ...
            n ? ("content" === i && (l -= S.css(t, "padding" + it[a], !0, o)),
            "margin" !== i && (l -= S.css(t, "border" + it[a] + "Width", !0, o))) : (l += S.css(t, "padding" + it[a], !0, o),
            "padding" !== i ? l += S.css(t, "border" + it[a] + "Width", !0, o) : s += S.css(t, "border" + it[a] + "Width", !0, o));
        return !n && 0 <= r && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - r - l - s - .5)) || 0),
        l
    }
    function ce(t, e, i) {
        var n = Qt(t)
        ...
        return (!y.boxSizingReliable() && o || !y.reliableTrDimensions() && E(t, "tr") || "auto" === a || !parseFloat(a) && "inline" === S.css(t, "display", !1, n)) && t.getClientRects().length && (o = "border-box" === S.css(t, "boxSizing", !1, n),
        (r = s in t) && (a = t[s])),
    ...
    S.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, a, s = U(e), l = oe.test(e), c = t.style;
                if (l || (e = ie(s)),
                a = S.cssHooks[e] || S.cssHooks[s],
                void 0 === i)
                    return a && "get"in a && void 0 !== (o = a.get(t, !1, n)) ? o : c[e];
                "string" == (r = typeof i) && (o = et.exec(i)) && o[1] && (i = st(t, e, o),
                r = "number"),
                null != i && i == i && ("number" !== r || l || (i += o && o[3] || (S.cssNumber[s] ? "" : "px")),
    ...
    S.each(["height", "width"], function(t, l) {
        S.cssHooks[l] = {
            get: function(t, e, i) {
                if (e)
                    return !ne.test(S.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ce(t, l, i) : Nt(t, re, function() {
                        return ce(t, l, i)
                    })
            },
            set: function(t, e, i) {
                var n, o = Qt(t), r = !y.scrollboxSize() && "absolute" === o.position, a = (r || i) && "border-box" === S.css(t, "boxSizing", !1, o), s = i ? le(t, l, i, a, o) : 0;
                return a && r && (s -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - le(t, l, "border", !1, o) - .5)),
                s && (n = et.exec(e)) && "px" !== (n[3] || "px") && (t.style[l] = e,
                e = S.css(t, l)),
                se(0, e, s)
            }
        }
    ...
    S.cssHooks.marginLeft = Gt(y.reliableMarginLeft, function(t, e) {
        if (e)
            return (parseFloat(Xt(t, "marginLeft")) || t.getBoundingClientRect().left - Nt(t, {
                marginLeft: 0
            }, function() {
    ...
    function ve() {
        de && (!1 === k.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(ve) : C.setTimeout(ve, S.fx.interval),
        S.fx.tick())
    }
    function ye() {
    ...
    function we(r, t, e) {
        var i, a, n = 0, o = we.prefilters.length, s = S.Deferred().always(function() {
            delete l.elem
        }), l = function() {
            if (a)
                return !1;
            for (var t = he || ye(), e = Math.max(0, c.startTime + c.duration - t), i = 1 - (e / c.duration || 0), n = 0, o = c.tweens.length; n < o; n++)
                c.tweens[n].run(i);
            return s.notifyWith(r, [c, i, e]),
            i < 1 && o ? e : (o || s.notifyWith(r, [c, 1, 0]),
            s.resolveWith(r, [c]),
            !1)
        }, c = s.promise({
            elem: r,
            ...
            stop: function(t) {
                ...
                for (a = !0; e < i; e++)
                    c.tweens[e].run(1);
                return t ? (s.notifyWith(r, [c, 1, 0]),
                s.resolveWith(r, [c, t])) : s.rejectWith(r, [c, t]),
                this
            }
        }), u = c.props;
        for (function(t, e) {
            ...
            if (i = we.prefilters[n].call(c, r, u, c.opts))
                return b(i.stop) && (S._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                i;
        return S.map(u, xe, c),
    ...
    S.Animation = S.extend(we, {
        tweeners: {
            "*": [function(t, e) {
                ...
                return st(i.elem, t, et.exec(e), i),
                i
            }
            ]
        },
        tweener: function(t, e) {
            for (var i, n = 0, o = (t = b(t) ? (e = t,
            ["*"]) : t.match(F)).length; n < o; n++)
                i = t[n],
                we.tweeners[i] = we.tweeners[i] || [],
                we.tweeners[i].unshift(e)
        },
        prefilters: [function(t, e, i) {
            var n, o, r, a, s, l, c, u, h = "width"in e || "height"in e, d = this, f = {}, p = t.style, g = t.nodeType && at(t), m = X.get(t, "fxshow");
            for (n in i.queue || (null == (a = S._queueHooks(t, "fx")).unqueued && (a.unqueued = 0,
            s = a.empty.fire,
            ...
            if ((l = !S.isEmptyObject(e)) || !S.isEmptyObject(f))
                ...
                "none" === (u = S.css(t, "display")) && (c ? u = c : (ct([t], !0),
                c = t.style.display || c,
                u = S.css(t, "display"),
                ct([t]))),
                ...
                l = !1,
                f)
                    l || (m ? "hidden"in m && (g = m.hidden) : m = X.access(t, "fxshow", {
                        display: c
                    }),
                    r && (m.hidden = !g),
                    g && ct([t], !0),
    ...
    S.fn.extend({
        ...
        finish: function(a) {
            return !1 !== a && (a = a || "fx"),
            this.each(function() {
                var t, e = X.get(this), i = e[a + "queue"], n = e[a + "queueHooks"], o = S.timers, r = i ? i.length : 0;
                for (e.finish = !0,
                S.queue(this, a, []),
                n && n.stop && n.stop.call(this, !0),
                t = o.length; t--; )
                    o[t].elem === this && o[t].queue === a && (o[t].anim.stop(!0),
                    o.splice(t, 1));
                for (t = 0; t < r; t++)
    ...
    S.extend({
        attr: function(t, e, i) {
            ...
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? S.prop(t, e, i) : (1 === r && S.isXMLDoc(t) || (o = S.attrHooks[e.toLowerCase()] || (S.expr.match.bool.test(e) ? _e : void 0)),
                void 0 !== i ? null === i ? void S.removeAttr(t, e) : o && "set"in o && void 0 !== (n = o.set(t, i, e)) ? n : (t.setAttribute(e, i + ""),
                i) : !(o && "get"in o && null !== (n = o.get(t, e))) && null == (n = S.find.attr(t, e)) ? void 0 : n)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
    ...
    _e = {
        set: function(t, e, i) {
            return !1 === e ? S.removeAttr(t, i) : t.setAttribute(i, i),
            i
        }
    },
    ...
    S.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var i, n, o = t.options, r = S.makeArray(e), a = o.length; a--; )
                        ((n = o[a]).selected = -1 < S.inArray(S.valHooks.option.get(n), r)) && (i = !0);
    ...
    S.extend(S.event, {
        trigger: function(t, e, i, n) {
            var o, r, a, s, l, c, u, h = [i || k], d = v.call(t, "type") ? t.type : t, f = v.call(t, "namespace") ? t.namespace.split(".") : [], p = u = r = i = i || k;
            if (3 !== i.nodeType && 8 !== i.nodeType && !Me.test(d + S.event.triggered) && (-1 < d.indexOf(".") && (d = (f = d.split(".")).shift(),
            f.sort()),
            s = d.indexOf(":") < 0 && "on" + d,
            ...
            n || !c.trigger || !1 !== c.trigger.apply(i, e))) {
                if (!n && !c.noBubble && !g(i)) {
                    ...
                    Me.test(a + d) || (p = p.parentNode); p; p = p.parentNode)
                        h.push(p),
                        r = p;
                ...
                for (o = 0; (p = h[o++]) && !t.isPropagationStopped(); )
                    ...
                    (l = s && p[s]) && l.apply && Q(p) && (t.result = l.apply(p, e),
                    !1 === t.result && t.preventDefault());
                return t.type = d,
                n || t.isDefaultPrevented() || c._default && !1 !== c._default.apply(h.pop(), e) || !Q(i) || s && b(i[d]) && !g(i) && ((r = i[s]) && (i[s] = null),
                S.event.triggered = d,
    ...
    function Ge(r) {
        return function(t, e) {
            "string" != typeof t && (e = t,
            t = "*");
            var i, n = 0, o = t.toLowerCase().match(F) || [];
            if (b(e))
                for (; i = o[n++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    function Ke(e, o, r, a) {
        ...
        function c(t) {
            ...
            S.each(e[t] || [], function(t, e) {
                var i = e(o, r, a);
                return "string" != typeof i || l || s[i] ? l ? !(n = i) : void 0 : (o.dataTypes.unshift(i),
                c(i),
                !1)
            }),
            n
    ...
    S.extend({
        ...
        ajax: function(t, e) {
            ...
            t = void 0),
            e = e || {};
            var u, h, d, i, f, n, p, g, o, r, m = S.ajaxSetup({}, e), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? S(v) : S.event, b = S.Deferred(), x = S.Callbacks("once memory"), w = m.statusCode || {}, a = {}, s = {}, l = "canceled", _ = {
                readyState: 0,
            ...
            null == m.crossDomain) {
                ...
                try {
                    n.href = m.url,
                    n.href = n.href,
                    m.crossDomain = Xe.protocol + "//" + Xe.host != n.protocol + "//" + n.host
                } catch (t) {
                    m.crossDomain = !0
                }
            }
            ...
            h = m.url.replace(Be, ""),
            m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(We, "+")) : (r = m.url.slice(h.length),
            m.data && (m.processData || "string" == typeof m.data) && (h += (Le.test(h) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (h = h.replace(He, "$1"),
            r = (Le.test(h) ? "&" : "?") + "_=" + Oe.guid++ + r),
            m.url = h + r),
            m.ifModified && (S.lastModified[h] && _.setRequestHeader("If-Modified-Since", S.lastModified[h]),
            S.etag[h] && _.setRequestHeader("If-None-Match", S.etag[h])),
            (m.data && m.hasContent && !1 !== m.contentType || e.contentType) && _.setRequestHeader("Content-Type", m.contentType),
            _.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ye + "; q=0.01" : "") : m.accepts["*"]),
            m.headers)
            ...
            function c(t, e, i, n) {
                ...
                o ? (m.ifModified && ((l = _.getResponseHeader("Last-Modified")) && (S.lastModified[h] = l),
                (l = _.getResponseHeader("etag")) && (S.etag[h] = l)),
                204 === t || "HEAD" === m.type ? c = "nocontent" : 304 === t ? c = "notmodified" : (c = s.state,
                r = s.data,
                o = !(a = s.error))) : (a = c,
                !t && c || (c = "error",
                t < 0 && (t = 0))),
        ...
        if (y.cors || ti && !o.crossDomain)
            return {
                send: function(t, e) {
                    ...
                    r = function(t) {
                        return function() {
                            r && (r = a = n.onload = n.onerror = n.onabort = n.ontimeout = n.onreadystatechange = null,
    ...
    S.ajaxPrefilter("json jsonp", function(t, e, i) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            return n = t.jsonpCallback = b(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
            ...
            ,
            i.always(function() {
                void 0 === o ? S(C).removeProp(n) : C[n] = o,
    ...
    y.createHTMLDocument = ((ei = k.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === ei.childNodes.length),
    S.parseHTML = function(t, e, i) {
        return "string" != typeof t ? [] : ("boolean" == typeof e && (i = e,
        e = !1),
        e || (y.createHTMLDocument ? ((n = (e = k.implementation.createHTMLDocument("")).createElement("base")).href = k.location.href,
    ...
    S.fn.load = function(t, e, i) {
        ...
        0 < a.length && S.ajax({
            ...
            r = arguments,
            a.html(n ? S("<div>").append(S.parseHTML(t)).find(n) : t)
    ...
    S.offset = {
        setOffset: function(t, e, i) {
            var n, o, r, a, s, l, c = S.css(t, "position"), u = S(t), h = {};
            "static" === c && (t.style.position = "relative"),
            s = u.offset(),
            r = S.css(t, "top"),
            l = S.css(t, "left"),
            o = ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (a = (n = u.position()).top,
            n.left) : (a = parseFloat(r) || 0,
            parseFloat(l) || 0),
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === S.css(n, "position"))
                    ...
                    for (e = this.offset(),
                    i = n.ownerDocument,
                    t = n.offsetParent || i.documentElement; t && (t === i.body || t === i.documentElement) && "static" === S.css(t, "position"); )
                        t = t.parentNode;
                    t && t !== n && 1 === t.nodeType && ((o = S(t).offset()).top += S.css(t, "borderTopWidth", !0),
    ...
    S.each({
        ...
        S.fn[e] = function(t) {
            return H(this, function(t, e, i) {
                var n;
                if (g(t) ? n = t : 9 === t.nodeType && (n = t.defaultView),
                void 0 === i)
                    return n ? n[o] : t[e];
    ...
    S.each({
        ...
        S.each({
            ...
            S.fn[r] = function(t, e) {
                ...
                return H(this, function(t, e, i) {
                    var n;
                    return g(t) ? 0 === r.indexOf("outer") ? t["inner" + a] : t.document.documentElement["client" + a] : 9 === t.nodeType ? (n = t.documentElement,
                    Math.max(t.body["scroll" + a], n["scroll" + a], t.body["offset" + a], n["offset" + a], n["client" + a])) : void 0 === i ? S.css(t, e, o) : S.style(t, e, i, o)
                }, s, i ? t : void 0, i)
            }
        })
    }),
...
function(t, e) {
    ...
    function b(t) {
        ...
        for (var e = v(10) ? document.body : null, i = t.offsetParent || null; i === e && t.nextElementSibling; )
    ...
    function y(t, e) {
        ...
        if (t !== l && e !== l || n.contains(o))
            return "BODY" === (s = (a = l).nodeName) || "HTML" !== s && b(a.firstElementChild) !== a ? b(l) : l;
        var c = u(t);
    ...
    function k(t) {
        var e, i, n = {};
        try {
            v(10) ? (n = t.getBoundingClientRect(),
            e = w(t, "top"),
            i = w(t, "left"),
            n.top += e,
            n.left += i,
            n.bottom += e,
            n.right += i) : n = t.getBoundingClientRect()
        } catch (t) {}
        var o, r = {
            left: n.left,
            top: n.top,
        ...
        }, a = "HTML" === t.nodeName ? _(t.ownerDocument) : {}, s = a.width || t.clientWidth || r.width, l = a.height || t.clientHeight || r.height, c = t.offsetWidth - s, u = t.offsetHeight - l;
        return (c || u) && (c -= h(o = x(t), "x"),
        u -= h(o, "y"),
        r.width -= c,
        r.height -= u),
        C(r)
    ...
    function S(t, e, i) {
        ...
        p.marginLeft = 0,
        !o && r && (d = parseFloat(c.marginTop, 10),
        ...
        p.marginTop = d,
        p.marginLeft = f),
        (o && !n ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (p = function(t, e, i) {
            var n = 2 < arguments.length && void 0 !== i && i
              , o = w(e, "top")
              , r = w(e, "left")
              , a = n ? -1 : 1;
    ...
    function f(t, e, i, n, o) {
        var r, a, s, l, c, u = 4 < arguments.length && void 0 !== o && o, h = {
            top: 0,
            left: 0
        }, d = u ? T(t) : y(t, m(e));
        ...
        }(d, u) : ("scrollParent" === n ? "BODY" === (r = g(p(e))).nodeName && (r = t.ownerDocument.documentElement) : r = "window" === n ? t.ownerDocument.documentElement : n,
        a = S(r, d, u),
        "HTML" !== r.nodeName || function t(e) {
            var i = e.nodeName;
            if ("BODY" === i || "HTML" === i)
                return !1;
            if ("fixed" === x(e, "position"))
                return !0;
            var n = p(e);
            return !!n && t(n)
        }(d) ? h = a : (l = (s = _(t.ownerDocument)).height,
        c = s.width,
        ...
        return h.left += f ? i : i.left || 0,
        h.top += f ? i : i.top || 0,
        h.right -= f ? i : i.right || 0,
        h.bottom -= f ? i : i.bottom || 0,
        h
    }
    ...
    function A(t, e, i) {
        ...
        var n = E(t)
          ...
          , l = r ? "height" : "width"
          , c = r ? "width" : "height";
        return o[a] = e[a] + e[l] / 2 - n[l] / 2,
        o[s] = i === s ? e[s] - n[c] : e[I(s)],
        o
    }
    function D(t, e) {
    ...
    function M(t, i, e) {
        return (void 0 === e ? t : t.slice(0, function(t, e, i) {
            ...
            t.enabled && r(e) && (i.offsets.popper = C(i.offsets.popper),
            i.offsets.reference = C(i.offsets.reference),
            i = e(i, t))
        }),
        i
    }
    ...
    function e(t, e, i, n) {
        i.updateBound = n,
        a(t).addEventListener("resize", i.updateBound, {
            passive: !0
        });
        var o = g(t);
    ...
    function d(i, n) {
        Object.keys(n).forEach(function(t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && c(n[t]) && (e = "px"),
            i.style[t] = n[t] + e
        })
    }
    function O(t, e) {
        ...
        return (-1 === n ? [i] : [i.slice(0, n).concat([i[n].split(l)[0]]), [i[n].split(l)[1]].concat(i.slice(n + 1))]).map(function(t, e) {
            ...
            return t.reduce(function(t, e) {
                ...
                return function(t, e, i, n) {
                    var o, r = t.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), a = +r[1], s = r[2];
                    if (!a)
                        return t;
                    if (0 !== s.indexOf("%"))
                        return "vh" !== s && "vw" !== s ? a : ("vh" === s ? W(document.documentElement.clientHeight, window.innerHeight || 0) : W(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * a;
                    switch (s) {
                    case "%p":
                        o = i;
                        break;
    ...
    var N = Math.min
      ...
      , H = function() {
        for (var t = ["Edge", "Trident", "Firefox"], e = 0; e < t.length; e += 1)
            if (B && 0 <= navigator.userAgent.indexOf(t[e]))
                return 1;
        return 0
    }()
    ...
    tt.Defaults = {
        ...
        modifiers: {
            shift: {
                ...
                enabled: !0,
                fn: function(t) {
                    var e, i, n, o, r, a, s, l = t.placement, c = l.split("-")[0], u = l.split("-")[1];
                    return u && (i = (e = t.offsets).reference,
                    n = e.popper,
                ...
                fn: function(t, n) {
                    ...
                    var c = n.priority
                      ...
                      , h = {
                        primary: function(t) {
                            var e = u[t];
                            return u[t] < l[t] && !n.escapeWithReference && (e = W(u[t], l[t])),
                            z({}, t, e)
                        },
                        secondary: function(t) {
                            var e = "right" === t ? "left" : "top"
                              , i = u[e];
                            return u[t] > l[t] && !n.escapeWithReference && (i = N(u[e], l[t] - ("right" === t ? u.width : u.height))),
                            z({}, e, i)
                        }
                    };
            ...
            keepTogether: {
                ...
                fn: function(t) {
                    var e = t.offsets
                      ...
                      , l = a ? "left" : "top"
                      , c = a ? "width" : "height";
                    return i[s] < r(n[l]) && (t.offsets.popper[l] = r(n[l]) - i[c]),
                    i[l] > r(n[s]) && (t.offsets.popper[l] = r(n[s])),
                    t
                }
            },
            arrow: {
                ...
                fn: function(t, e) {
                    var i;
                    if (!L(t.instance.modifiers, "arrow", "keepTogether"))
                        return t;
                    var n = e.element;
                    if ("string" == typeof n) {
                    ...
                    var o = t.placement.split("-")[0]
                      ...
                      , f = l ? "bottom" : "right"
                      , p = E(n)[c];
                    s[f] - p < a[h] && (t.offsets.popper[h] -= a[h] - (s[f] - p)),
                    s[h] + p > a[f] && (t.offsets.popper[h] += s[h] + p - a[f]),
                    ...
                    var g = s[h] + s[c] / 2 - p / 2
                      ...
                      , b = W(N(a[c] - p, b), 0);
                    return t.arrowElement = n,
                    t.offsets.arrow = (z(i = {}, h, j(b)),
                    z(i, d, ""),
                    i),
                    t
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(m, v) {
                    if (t(m.instance.modifiers, "inner"))
                        return m;
            ...
            inner: {
                ...
                fn: function(t) {
                    ...
                    return o[a ? "left" : "top"] = r[i] - (s ? o[a ? "width" : "height"] : 0),
                    t.placement = I(e),
            ...
            hide: {
                ...
                enabled: !0,
                fn: function(t) {
                    if (!L(t.instance.modifiers, "hide", "preventOverflow"))
                        return t;
            ...
            computeStyle: {
                ...
                fn: function(t, e) {
                    ...
                    var a, s, l = void 0 === r ? e.gpuAcceleration : r, c = b(t.instance.popper), u = k(c), h = {
                        position: o.position
                    }, d = O(t, window.devicePixelRatio < 2 || !Y), f = "bottom" === i ? "top" : "bottom", p = "right" === n ? "left" : "right", g = P("transform"), m = "bottom" == f ? "HTML" === c.nodeName ? -c.clientHeight + d.bottom : -u.height + d.bottom : d.top, v = "right" == p ? "HTML" === c.nodeName ? -c.clientWidth + d.right : -u.width + d.right : d.left;
                    l && g ? (h[g] = "translate3d(" + v + "px, " + m + "px, 0)",
                    h[f] = 0,
                    h[p] = 0,
                    h.willChange = "transform") : (a = "bottom" == f ? -1 : 1,
                    s = "right" == p ? -1 : 1,
                    h[f] = m * a,
                    h[p] = v * s,
                    h.willChange = f + ", " + p);
                    ...
                    return t.attributes = Q({}, y, t.attributes),
                    t.styles = Q({}, h, t.styles),
...
function(t, e) {
    ...
    var i, o = "alert", s = p.fn[o], l = ((i = c.prototype).close = function(t) {
        var e = this._element;
    ...
    i._removeElement = function(e) {
        ...
        p(e).hasClass("fade") ? (t = g.getTransitionDurationFromElement(e),
    ...
    ;
    var u, d = p.fn.button, f = ((u = m.prototype).toggle = function() {
        var t, e, i = !0, n = !0, o = p(this._element).closest('[data-toggle="buttons"]')[0];
        !o || (t = this._element.querySelector('input:not([type="hidden"])')) && ("radio" === t.type && (t.checked && this._element.classList.contains("active") ? i = !1 : (e = o.querySelector(".active")) && p(e).removeClass("active")),
        ...
        i && p(this._element).toggleClass("active"))
    }
    ,
    u.dispose = function() {
    ...
    p(document).on("click.bs.button.data-api", '[data-toggle^="button"]', function(t) {
        var e = t.target
          , i = e;
        if (p(e).hasClass("btn") || (e = p(e).closest(".btn")[0]),
        !e || e.hasAttribute("disabled") || e.classList.contains("disabled"))
            ...
            "LABEL" === i.tagName && n && "checkbox" === n.type && t.preventDefault(),
            f._jQueryInterface.call(p(e), "toggle")
        }
    ...
    p.fn.button.noConflict = function() {
        return p.fn.button = d,
        f._jQueryInterface
    }
    ;
    var v, y = "carousel", b = p.fn[y], x = {
        interval: 5e3,
        keyboard: !0,
        slide: !1,
        pause: "hover",
    ...
    v._addTouchEventListeners = function() {
        ...
        this._pointerEvent ? (p(this._element).on("pointerdown.bs.carousel", t),
        p(this._element).on("pointerup.bs.carousel", e),
        this._element.classList.add("pointer-event")) : (p(this._element).on("touchstart.bs.carousel", t),
    ...
    v._slide = function(t, e) {
        var i, n, o, r, a, s = this, l = this._element.querySelector(".active.carousel-item"), c = this._getItemIndex(l), u = e || l && this._getItemByDirection(t, l), h = this._getItemIndex(u), d = Boolean(this._interval), f = "next" === t ? (i = "carousel-item-left",
        n = "carousel-item-next",
        "left") : (i = "carousel-item-right",
        n = "carousel-item-prev",
        "right");
        u && p(u).hasClass("active") ? this._isSliding = !1 : !this._triggerSlideEvent(u, f).isDefaultPrevented() && l && u && (this._isSliding = !0,
        d && this.pause(),
        this._setActiveIndicatorElement(u),
        o = p.Event("slid.bs.carousel", {
            relatedTarget: u,
            direction: f,
            from: c,
            to: h
        }),
        p(this._element).hasClass("slide") ? (p(u).addClass(n),
        g.reflow(u),
        p(l).addClass(i),
        p(u).addClass(i),
        ...
        p(l).one(g.TRANSITION_END, function() {
            p(u).removeClass(i + " " + n).addClass("active"),
            p(l).removeClass("active " + n + " " + i),
            s._isSliding = !1,
            setTimeout(function() {
                return p(s._element).trigger(o)
            }, 0)
        }).emulateTransitionEnd(a)) : (p(l).removeClass("active"),
        p(u).addClass("active"),
        this._isSliding = !1,
    ...
    k._dataApiClickHandler = function(t) {
        ...
        !o || (e = p(o)[0]) && p(e).hasClass("carousel") && (i = a(a({}, p(e).data()), p(this).data()),
    ...
    S.show = function() {
        ...
        t && (e = p(t).not(this._selector).data("bs.collapse")) && e._isTransitioning) || (i = p.Event("show.bs.collapse"),
        p(this._element).trigger(i),
        i.isDefaultPrevented() || (t && (M._jQueryInterface.call(p(t).not(this._selector), "hide"),
        e || p(t).data("bs.collapse", null)),
        ...
        p(this._element).one(g.TRANSITION_END, function() {
            p(a._element).removeClass("collapsing").addClass("collapse show"),
            a._element.style[n] = "",
        ...
        if (!this._isTransitioning && p(this._element).hasClass("show")) {
            ...
            !e.isDefaultPrevented()) {
                ...
                p(this._element).one(g.TRANSITION_END, function() {
                    ...
                    p(t._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")
    ...
    S._getConfig = function(t) {
        return (t = a(a({}, I), t)).toggle = Boolean(t.toggle),
        g.typeCheckConfig(T, t, A),
        t
    }
    ,
    ...
    ;
    var P, O = "dropdown", L = p.fn[O], F = new RegExp("38|40|27"), z = {
        offset: 0,
        flip: !0,
        ...
        var t;
        this._element.disabled || p(this._element).hasClass("disabled") || (t = p(this._menu).hasClass("show"),
        j._clearMenus(),
        t || this.show(!0))
    }
    ,
        ...
        !(this._element.disabled || p(this._element).hasClass("disabled") || p(this._menu).hasClass("show"))) {
            ...
            !i.isDefaultPrevented()) {
                if (!this._inNavbar && t) {
                    ...
                    var o = this._element;
                    "parent" === this._config.reference ? o = n : g.isElement(this._config.reference) && (o = this._config.reference,
    ...
    P.hide = function() {
        ...
        p(this._menu).toggleClass("show"),
        p(i).toggleClass("show").trigger(p.Event("hidden.bs.dropdown", t))))
    }
    ,
    P.dispose = function() {
    ...
    P._getConfig = function(t) {
        return t = a(a(a({}, this.constructor.Default), p(this._element).data()), t),
        g.typeCheckConfig(O, t, this.constructor.DefaultType),
        t
    }
    ,
    P._getMenuElement = function() {
        var t;
        return this._menu || (t = j._getParentFromElement(this._element)) && (this._menu = t.querySelector(".dropdown-menu")),
        this._menu
    }
    ,
    P._getPlacement = function() {
        var t = p(this._element.parentNode)
          , e = "bottom-start";
        return t.hasClass("dropup") ? e = p(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : p(this._menu).hasClass("dropdown-menu-right") && (e = "bottom-end"),
        e
    }
    ,
    ...
    j._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new j(this,"object" == typeof e ? e : null),
            p(this).data("bs.dropdown", t)),
            "string" == typeof e) {
                if (void 0 === t[e])
    ...
    j._clearMenus = function(t) {
        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
            for (var e = [].slice.call(document.querySelectorAll('[data-toggle="dropdown"]')), i = 0, n = e.length; i < n; i++) {
                var o, r, a = j._getParentFromElement(e[i]), s = p(e[i]).data("bs.dropdown"), l = {
                    relatedTarget: e[i]
                };
                t && "click" === t.type && (l.clickEvent = t),
                s && (o = s._menu,
                !p(a).hasClass("show") || t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(a, t.target) || (r = p.Event("hide.bs.dropdown", l),
                p(a).trigger(r),
        ...
        if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(".dropdown-menu").length) : !F.test(t.which)) && !this.disabled && !p(this).hasClass("disabled")) {
            ...
            if (i || 27 !== t.which) {
                ...
                !i || i && (27 === t.which || 32 === t.which))
                    return 27 === t.which && p(e.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
    ...
    p(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', R._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", R._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", R._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', function(t) {
        t.preventDefault(),
        t.stopPropagation(),
        R._jQueryInterface.call(p(this), "toggle")
    ...
    W.hide = function(t) {
        var e, i, n, o = this;
        t && t.preventDefault(),
        this._isShown && !this._isTransitioning && (e = p.Event("hide.bs.modal"),
        p(this._element).trigger(e),
        ...
        i ? (n = g.getTransitionDurationFromElement(this._element),
    ...
    W._showElement = function(t) {
        ...
        i ? (r = g.getTransitionDurationFromElement(this._dialog),
        p(this._dialog).one(g.TRANSITION_END, o).emulateTransitionEnd(r)) : o()
    }
    ,
    ...
    W._hideModal = function() {
        ...
        this._showBackdrop(function() {
            ...
            t._resetAdjustments(),
            t._resetScrollbar(),
            p(t._element).trigger("hidden.bs.modal")
        })
    }
    ,
    ...
    W._showBackdrop = function(t) {
        var e, i, n = this, o = p(this._element).hasClass("fade") ? "fade" : "";
        if (this._isShown && this._config.backdrop) {
            ...
            ,
            p(this._element).hasClass("fade") ? (i = g.getTransitionDurationFromElement(this._backdrop),
            p(this._backdrop).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e()) : t && t()
    }
    ,
        ...
        for (var i = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(a), l = [].slice.call(i.body.querySelectorAll("*")), n = function(t, e) {
            ...
            o.forEach(function(t) {
                !function(t, e) {
                    ...
                    if (-1 !== e.indexOf(i))
                        return -1 === U.indexOf(i) || Boolean(t.nodeValue.match(Q) || t.nodeValue.match(Y));
    ...
    var G, K = "tooltip", Z = p.fn[K], J = new RegExp("(^|\\s)bs-tooltip\\S+","g"), tt = ["sanitize", "whiteList", "sanitizeFn"], et = {
        animation: "boolean",
        template: "string",
    ...
    G.show = function() {
        ...
        if (this.isWithContent() && this._isEnabled) {
            ...
            this.setContent(),
            this.config.animation && p(o).addClass("fade");
    ...
    G.hide = function(t) {
        ...
        var i, n = this, o = this.getTipElement(), r = p.Event(this.constructor.Event.HIDE);
        p(this.element).trigger(r),
        r.isDefaultPrevented() || (p(o).removeClass("show"),
        "ontouchstart"in document.documentElement && p(document.body).children().off("mouseover", null, p.noop),
        this._activeTrigger.click = !1,
        this._activeTrigger.focus = !1,
        this._activeTrigger.hover = !1,
        p(this.tip).hasClass("fade") ? (i = g.getTransitionDurationFromElement(o),
        p(o).one(g.TRANSITION_END, e).emulateTransitionEnd(i)) : e(),
        this._hoverState = "")
    }
    ,
    G.update = function() {
    ...
    G.setContent = function() {
        ...
        p(t).removeClass("fade show")
    }
    ,
    G.setElementContent = function(t, e) {
        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = X(e, this.config.whiteList, this.config.sanitizeFn)),
    ...
    G._setListeners = function() {
        ...
        this.config.trigger.split(" ").forEach(function(t) {
            ...
            p(n.element).on(e, n.config.selector, function(t) {
                return n._enter(t)
    ...
    G._enter = function(t, e) {
        ...
        (e = e || p(t.currentTarget).data(i)) || (e = new this.constructor(t.currentTarget,this._getDelegateConfig()),
        p(t.currentTarget).data(i, e)),
        t && (e._activeTrigger["focusin" === t.type ? "focus" : "hover"] = !0),
        p(e.getTipElement()).hasClass("show") || "show" === e._hoverState ? e._hoverState = "show" : (clearTimeout(e._timeout),
        e._hoverState = "show",
    ...
    G._fixTransition = function() {
        ...
        null === t.getAttribute("x-placement") && (p(t).removeClass("fade"),
    ...
    at._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this).data("bs.tooltip")
              , e = "object" == typeof i && i;
            if ((t || !/dispose|hide/.test(i)) && (t || (t = new at(this,e),
            p(this).data("bs.tooltip", t)),
            "string" == typeof i)) {
                if (void 0 === t[i])
                    throw new TypeError('No method named "' + i + '"');
                t[i]()
    ...
    ;
    var pt, gt = "scrollspy", mt = p.fn[gt], vt = {
        offset: 10,
        method: "auto",
        target: ""
    }, yt = {
    ...
    pt._getConfig = function(t) {
        var e;
        return "string" != typeof (t = a(a({}, vt), "object" == typeof t && t ? t : {})).target && g.isElement(t.target) && ((e = p(t.target).attr("id")) || (e = g.getUID(gt),
    ...
    xt._jQueryInterface = function(e) {
        return this.each(function() {
            ...
            if (t || (t = new xt(this,"object" == typeof e && e),
            p(this).data("bs.scrollspy", t)),
            "string" == typeof e) {
                if (void 0 === t[e])
                    throw new TypeError('No method named "' + e + '"');
                t[e]()
    ...
    ;
    var wt, _t = p.fn.tab, Ct = ((wt = kt.prototype).show = function() {
        var t, e, i, n, o, r, a, s, l = this;
        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass("active") || p(this._element).hasClass("disabled") || (e = p(this._element).closest(".nav, .list-group")[0],
        i = g.getSelectorFromElement(this._element),
        e && (n = "UL" === e.nodeName || "OL" === e.nodeName ? "> li > .active" : ".active",
        o = (o = p.makeArray(p(e).find(n)))[o.length - 1]),
        ...
        a.isDefaultPrevented() || r.isDefaultPrevented() || (i && (t = document.querySelector(i)),
    ...
    wt._activate = function(t, e, i) {
        ...
        var o, r = this, a = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(".active") : p(e).find("> li > .active"))[0], s = i && a && p(a).hasClass("fade");
        a && s ? (o = g.getTransitionDurationFromElement(a),
        p(a).removeClass("show").one(g.TRANSITION_END, n).emulateTransitionEnd(o)) : n()
    }
    ,
    wt._transitionComplete = function(t, e, i) {
        var n, o, r;
        e && (p(e).removeClass("active"),
        ...
        t.parentNode && p(t.parentNode).hasClass("dropdown-menu") && ((o = p(t).closest(".dropdown")[0]) && (r = [].slice.call(o.querySelectorAll(".dropdown-toggle")),
        p(r).addClass("active")),
    ...
    p(document).on("click.bs.tab.data-api", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(),
        Ct._jQueryInterface.call(p(this), "show")
    }),
    ...
    var St, Tt = p.fn.toast, Et = {
        ...
        var t, e, i = this, n = p.Event("show.bs.toast");
        p(this._element).trigger(n),
        n.isDefaultPrevented() || (this._config.animation && this._element.classList.add("fade"),
        t = function() {
        ...
        this._config.animation ? (e = g.getTransitionDurationFromElement(this._element),
        p(this._element).one(g.TRANSITION_END, t).emulateTransitionEnd(e)) : t())
    }
    ,
    St.hide = function() {
        var t;
        this._element.classList.contains("show") && (t = p.Event("hide.bs.toast"),
    ...
    St._getConfig = function(t) {
        return t = a(a(a({}, It), p(this._element).data()), "object" == typeof t && t ? t : {}),
        g.typeCheckConfig("toast", t, this.constructor.DefaultType),
        t
    }
    ,
    ...
    St._close = function() {
        function t() {
            ...
            p(i._element).trigger("hidden.bs.toast")
        }
        var e, i = this;
    ...
    Dt._jQueryInterface = function(i) {
        return this.each(function() {
            var t = p(this)
              , e = t.data("bs.toast");
            if (e || (e = new Dt(this,"object" == typeof i && i),
            t.data("bs.toast", e)),
            "string" == typeof i) {
                if (void 0 === e[i])
                    throw new TypeError('No method named "' + i + '"');
...
function(p) {
    p.fn.extend({
        easyResponsiveTabs: function(l) {
            ...
            this.each(function() {
                var i, r = p(this), t = r.find("ul.resp-tabs-list." + l.tabidentify), a = r.attr("id");
                r.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify),
                r.css({
                    display: "block",
                    width: h
                }),
                "vertical" == l.type && r.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color),
                r.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify),
                function() {
                    ...
                    "accordion" == c && (r.addClass("resp-easy-accordion").addClass(l.tabidentify),
                    r.find(".resp-tabs-list").css("display", "none"))
                }(),
                ...
                r.find(".resp-tab-content." + l.tabidentify).prev("h2").css({
                ...
                var o, s = 0;
                "" == d || null !== (o = d.match(new RegExp(a + "([0-9]+)"))) && 2 === o.length && (s = parseInt(o[1], 10) - 1,
                e < s && (s = 0)),
                p(r.find(".resp-tab-item." + l.tabidentify)[s]).addClass("resp-tab-active").css({
                ...
                p(r.find(".resp-tab-content." + l.tabidentify)[s]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")),
                r.find("[role=tab]").each(function() {
                    p(this).on("click", function() {
                        var t, e, i, n = p(this), o = n.attr("aria-controls");
                        if (n.hasClass("resp-accordion") && n.hasClass("resp-tab-active"))
                            return r.find(".resp-tab-content-active." + l.tabidentify).slideUp("", function() {
                                p(this).addClass("resp-accordion-closed")
                            }),
                            n.removeClass("resp-tab-active").css({}),
                            !1;
                        !n.hasClass("resp-tab-active") && n.hasClass("resp-accordion") ? (r.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        r.find(".resp-tab-content-active." + l.tabidentify).slideUp().removeClass("resp-tab-content-active resp-accordion-closed"),
                        r.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}),
                        r.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).slideDown().addClass("resp-tab-content-active")) : (r.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        r.find(".resp-tab-content-active." + l.tabidentify).removeAttr("style").removeClass("resp-tab-content-active").removeClass("resp-accordion-closed"),
                        r.find("[aria-controls=" + o + "]").addClass("resp-tab-active").css({}),
                        r.find(".resp-tab-content[aria-labelledby = " + o + "]." + l.tabidentify).addClass("resp-tab-content-active").attr("style", "display:block")),
                        n.trigger("tabactivate", n),
                        f && (t = window.location.hash,
                        o.split("tab_item-"),
                        i = (i = "") != t ? (e = new RegExp(a + "[0-9]+"),
...
function(l, i, o) {
    ...
    c.Workers = [{
        ...
        run: function() {
            ...
            l(s).addClass("cloned").prependTo(this.$stage)
        }
    }, {
        filter: ["width", "items", "settings"],
        run: function() {
        ...
        run: function() {
            for (var t, e, i = this.settings.rtl ? 1 : -1, n = 2 * this.settings.stagePadding, o = this.coordinates(this.current()) + n, r = o + this.width() * i, a = [], s = 0, l = this._coordinates.length; s < l; s++)
    ...
    c.prototype.closest = function(i, n) {
        ...
        return this.settings.freeDrag || l.each(a, l.proxy(function(t, e) {
            return "left" === n && e - 30 < i && i < e + 30 ? o = t : "right" === n && e - r - 30 < i && i < e - r + 30 ? o = t + 1 : this.op(i, "<", e) && this.op(i, ">", a[t + 1] || e - r) && (o = "left" === n ? t + 1 : t),
            -1 === o
        }, this)),
    ...
    c.prototype.current = function(t) {
        return void 0 === t ? this._current : 0 !== this._items.length ? (t = this.normalize(t),
        this._current !== t && (void 0 !== (e = this.trigger("change", {
            property: {
                name: "position",
                value: t
            }
    ...
    c.prototype.normalize = function(t, e) {
        ...
        return !this.isNumeric(t) || i < 1 ? t = void 0 : (t < 0 || i + n <= t) && (t = ((t - n / 2) % i + i) % i + n / 2),
        t
    }
    ,
    ...
    c.prototype.to = function(t, e) {
        var i = this.current()
          ...
          , s = this.minimum()
          , l = this.maximum();
        this.settings.loop ? (!this.settings.rewind && Math.abs(o) > a / 2 && (o += -1 * r * a),
        (n = (((t = i + o) - s) % a + a) % a + s) !== t && n - o <= l && 0 < n - o && (i = n - o,
        t = n,
        this.reset(i))) : t = this.settings.rewind ? (t % (l += 1) + l) % l : Math.max(s, Math.min(l, t)),
...
function(s, r) {
    ...
    e.prototype.load = function(t) {
        ...
        !i || -1 < s.inArray(e.get(0), this._loaded) || (i.each(s.proxy(function(t, e) {
            var i, n = s(e), o = 1 < r.devicePixelRatio && n.attr("data-src-retina") || n.attr("data-src");
            this._core.trigger("load", {
                element: n,
                url: o
            }, "lazy"),
            n.is("img") ? n.one("load.owl.lazy", s.proxy(function() {
                n.css("opacity", 1),
...
function(r) {
    ...
    e.prototype.update = function() {
        var t, e = this._core._current, i = e + this._core.settings.items, n = this._core.$stage.children().toArray().slice(e, i), o = [];
...
function(u, e) {
    ...
    i.prototype.fetch = function(t, e) {
        ...
        if (-1 < (n = a.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/))[3].indexOf("youtu"))
            i = "youtube";
    ...
    i.prototype.thumbnail = function(e, t) {
        function i(t) {
            n = c.lazyLoad ? '<div class="owl-video-tn ' + l + '" ' + s + '="' + t + '"></div>' : '<div class="owl-video-tn" style="opacity:1;background-image:url(' + t + ')"></div>',
            e.after(n),
            e.after('<div class="owl-video-play-icon"></div>')
        }
        var n, o, r = t.width && t.height ? 'style="width:' + t.width + "px;height:" + t.height + 'px;"' : "", a = e.find("img"), s = "src", l = "", c = this._core.settings;
    ...
    i.prototype.play = function(t) {
        var e, i = u(t.target).closest("." + this._core.settings.itemClass), n = this._videos[i.attr("data-video")], o = n.width || "100%", r = n.height || this._core.$stage.height();
        this._playing || (this._core.enter("playing"),
        this._core.trigger("play", null, "video"),
        i = this._core.items(this._core.relative(i.index())),
        this._core.reset(i.index()),
        "youtube" === n.type ? e = '<iframe width="' + o + '" height="' + r + '" src="//www.youtube.com/embed/' + n.id + "?autoplay=1&rel=0&v=" + n.id + '" frameborder="0" allowfullscreen></iframe>' : "vimeo" === n.type ? e = '<iframe src="//player.vimeo.com/video/' + n.id + '?autoplay=1" width="' + o + '" height="' + r + '" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>' : "vzaar" === n.type && (e = '<iframe frameborder="0"height="' + r + '"width="' + o + '" allowfullscreen mozallowfullscreen webkitAllowFullScreen src="//view.vzaar.com/' + n.id + '/player?autoplay=true"></iframe>'),
...
function(a) {
    ...
    e.prototype.swap = function() {
        var t, e, i, n, o, r;
        1 === this.core.settings.items && a.support.animation && a.support.transition && (this.core.speed(0),
        ...
        i.one(a.support.animation.end, e).css({
            left: t + "px"
...
function(i, n, o) {
    ...
    e.prototype._getNextTimeout = function(t, e) {
        return this._timeout && n.clearTimeout(this._timeout),
        n.setTimeout(i.proxy(function() {
    ...
    e.prototype.stop = function() {
        this._core.is("rotating") && (n.clearTimeout(this._timeout),
...
function(r) {
    ...
    ,
    e.prototype.update = function() {
        var t, e, i = this._core.clones().length / 2, n = i + this._core.items().length, o = this._core.maximum(!0), r = this._core.settings, a = r.center || r.autoWidth || r.dotsData ? 1 : r.dotsEach || r.items;
    ...
    e.prototype.getPosition = function(t) {
        ...
        return "page" == n.slideBy ? (e = r.inArray(this.current(), this._pages),
    ...
    e.prototype.to = function(t, e, i) {
        ...
        r.proxy(this._overrides.to, this._core)(this._pages[(t % n + n) % n].start, e)) : r.proxy(this._overrides.to, this._core)(t, e)
    }
    ,
...
function(o, r) {
    ...
    e("transition") && (o.support.transition = new String(i("transition")),
    o.support.transition.end = t.transition.end[o.support.transition]),
    e("animation") && (o.support.animation = new String(i("animation")),
    o.support.animation.end = t.animation.end[o.support.animation]),
    e("transform") && (o.support.transform = new String(i("transform")),
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            ...
            l.waypoint(function() {
                ...
                /^[0-9]+.[0-9]+$/.test(i)), r = o ? (i.split(".")[1] || []).length : 0, a = e; 1 <= a; a--) {
                    var s = parseInt(i / e * a);
                    if (o && (s = parseFloat(i / e * a).toFixed(r)),
                    n)
...
function(m, o, t, v) {
    var n = "stellar"
      ...
      , r = function() {
        var t, e = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/, i = m("script")[0].style, n = "";
        for (t in i)
            if (e.test(t)) {
                n = t.match(e)[0];
                break
    ...
    c.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$viewportElement = this.options.viewportElement !== v ? m(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        _defineSetters: function() {
            ...
            : m.noop,
            this._setPosition = a.setPosition || function(t, e, i, n, o) {
                r.options.horizontalScrolling && a.setLeft(t, e, i),
                r.options.verticalScrolling && a.setTop(t, n, o)
            }
        },
        ...
        refresh: function(t) {
            ...
            t && t.firstLoad && /WebKit/.test(navigator.userAgent) && m(o).on("load", function() {
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, n, o, r, a, s, l, c, u = m(this), h = 0, d = 0, f = 0, p = 0;
                ...
                e = u.data("stellar-horizontal-offset") !== v ? u.data("stellar-horizontal-offset") : s !== v && s.data("stellar-horizontal-offset") !== v ? s.data("stellar-horizontal-offset") : g.horizontalOffset,
                i = u.data("stellar-vertical-offset") !== v ? u.data("stellar-vertical-offset") : s !== v && s.data("stellar-vertical-offset") !== v ? s.data("stellar-vertical-offset") : g.verticalOffset,
                g.particles.push({
                    $element: u,
                    $offsetParent: s,
        ...
        _findBackgrounds: function() {
            var t, f = this, p = this._getScrollLeft(), g = this._getScrollTop();
            this.backgrounds = [],
            ...
            t.each(function() {
                var t, e, i, n, o, r, a, s = m(this), l = b(s), c = 0, u = 0, h = 0, d = 0;
                if (s.data("stellar-backgroundIsActive")) {
                    if (s.data("stellar-backgroundIsActive") !== this)
                        return
                } else
                    s.data("stellar-backgroundIsActive", this);
                s.data("stellar-backgroundStartingLeft") ? y(s, s.data("stellar-backgroundStartingLeft"), s.data("stellar-backgroundStartingTop")) : (s.data("stellar-backgroundStartingLeft", l[0]),
                s.data("stellar-backgroundStartingTop", l[1])),
                ...
                t = s.data("stellar-horizontal-offset") !== v ? s.data("stellar-horizontal-offset") : a !== v && a.data("stellar-horizontal-offset") !== v ? a.data("stellar-horizontal-offset") : f.horizontalOffset,
                e = s.data("stellar-vertical-offset") !== v ? s.data("stellar-vertical-offset") : a !== v && a.data("stellar-vertical-offset") !== v ? a.data("stellar-vertical-offset") : f.verticalOffset,
                f.backgrounds.push({
                    $element: s,
                    $offsetParent: a,
        ...
        destroy: function() {
            ...
            m(o).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function() {
            var t, e, i, n, o, r, a, s, l, c, u = this._getScrollLeft(), h = this._getScrollTop(), d = !0, f = !0;
            if (this.currentScrollLeft !== u || this.currentScrollTop !== h || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                ...
                c = this.particles.length - 1; 0 <= c; c--)
                    ...
                    s = this.options.horizontalScrolling ? (r = (u + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (r = t.startingPositionLeft,
                    t.startingOffsetLeft),
                    l = this.options.verticalScrolling ? (a = (h + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (a = t.startingPositionTop,
                    t.startingOffsetTop),
                    this.options.hideDistantElements && (f = !this.options.horizontalScrolling || s + t.width > (t.isFixed ? 0 : u) && s < (t.isFixed ? 0 : u) + this.viewportWidth + this.viewportOffsetLeft,
                    d = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : h) && l < (t.isFixed ? 0 : h) + this.viewportHeight + this.viewportOffsetTop),
                    f && d ? (t.isHidden && (this.options.showElement(t.$element),
                    t.isHidden = !1),
                    this._setPosition(t.$element, r, t.startingPositionLeft, a, t.startingPositionTop)) : t.isHidden || (this.options.hideElement(t.$element),
                    t.isHidden = !0);
    ...
    m.fn[n] = function(e) {
        ...
        return e === v || "object" == typeof e ? this.each(function() {
            ...
            "destroy" === e && m.data(this, "plugin_" + n, null)
        }) : void 0
    }
    ,
    m[n] = function(t) {
    ...
    i.prototype.handleScroll = function() {
        ...
        for (var i in e) {
            ...
            for (var r in this.waypoints[i]) {
                ...
                null !== l.triggerPoint && (a = n.oldScroll < l.triggerPoint,
                s = n.newScroll >= l.triggerPoint,
                (a && s || !a && !s) && (l.queueTrigger(o),
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (var a in this.waypoints[o]) {
                var s, l, c, u, h = this.waypoints[o][a], d = h.options.offset, f = h.triggerPoint, p = 0, g = null == f;
                h.element !== h.element.window && (p = h.adapter.offset()[r.offsetProp]),
                "function" == typeof d ? d = d.apply(h) : "string" == typeof d && (d = parseFloat(d),
                -1 < h.options.offset.indexOf("%") && (d = Math.ceil(r.contextDimension * d / 100))),
                s = r.contextScroll - r.contextOffset,
                h.triggerPoint = Math.floor(p + s - d),
                l = f < r.oldScroll,
                c = h.triggerPoint >= r.oldScroll,
                u = !l && !c,
                !g && (l && c) ? (h.queueTrigger(r.backward),
                n[h.group.id] = h.group) : (!g && u || g && r.oldScroll >= h.triggerPoint) && (h.queueTrigger(r.forward),
...
function(u) {
    ...
    u.fn.countdown = function(t, a) {
        ...
        function e() {
            ...
            "on" == l.format && (i = 2 <= String(i).length ? i : "0" + i,
            ...
            clearInterval(c)) : (s.find(".days").text(i),
            s.find(".hours").text(n),
            s.find(".minutes").text(o),
            s.find(".seconds").text(r))
        }
        t && u.extend(l, t),
        e();
...
function(t) {
    ...
    function r() {
        u.magnificPopup.instance || ((g = new t).init(),
        u.magnificPopup.instance = g)
    }
    var g, n, m, o, v, e, s = "Close", l = "BeforeClose", y = "MarkupParse", i = ".mfp", b = "mfp-ready", a = "mfp-removing", c = "mfp-prevent-close", x = !!window.jQuery, w = u(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            if (!1 === t.isObj) {
                ...
                g.items = u.isArray(t.items) ? t.items : [t.items],
                g.index = t.index || 0;
            if (!g.isOpen) {
                g.types = [],
                v = "",
                ...
                g.bgOverlay || (g.bgOverlay = d("bg").on("click.mfp", function() {
                    g.close()
                }),
                ...
                f("BeforeOpen"),
                g.st.showCloseBtn && (g.st.closeBtnInside ? (h(y, function(t, e, i, n) {
                    i.close_replaceWith = p(n.type)
                }),
                v += " mfp-close-btn-in") : g.wrap.append(p())),
        ...
        close: function() {
            g.isOpen && (f(l),
            g.isOpen = !1,
            g.st.removalDelay && !g.isLowIE && g.supportsTransition ? (g._addClassToMFP(a),
            setTimeout(function() {
                g._close()
        ...
        _close: function() {
            ...
            g.isIE7 ? u("body, html").css("overflow", "") : t.overflow = "",
            u("html").css(t)),
        ...
        updateItemHTML: function() {
            ...
            g.currItem = t,
            g.currTemplate[i] || (e = !!g.st[i] && g.st[i].markup,
            f("FirstMarkupParse", e),
            g.currTemplate[i] = !e || u(e)),
        ...
        updateStatus: function(t, e) {
            var i;
            g.preloader && (n !== t && g.container.removeClass("mfp-s-" + n),
        ...
        _checkIfClose: function(t) {
            if (!u(t).hasClass(c)) {
                ...
                if (e && i)
                    return !0;
                if (!g.content || u(t).hasClass("mfp-close") || g.preloader && t === g.preloader[0])
                    return !0;
        ...
        _onFocusIn: function(t) {
            return t.target === g.wrap[0] || u.contains(g.wrap[0], t.target) ? void 0 : (g._setFocus(),
            !1)
        },
    ...
    u.fn.magnificPopup = function(t) {
        r();
        var e, i, n, o = u(this);
        return "string" == typeof t ? "open" === t ? (e = x ? o.data("magnificPopup") : o[0].magnificPopup,
        ...
        g._openClick({
            mfpEl: n
        }, o, e)) : g.isOpen && g[t].apply(g, Array.prototype.slice.call(arguments, 1)) : (t = u.extend(!0, {}, t),
        x ? o.data("magnificPopup", t) : o[0].magnificPopup = t,
        g.addGroup(o, t)),
        o
    }
    ;
    function _() {
        S && (k.after(S.addClass(C)).detach(),
        S = null)
    }
    var C, k, S, T = "inline";
    u.magnificPopup.registerModule(T, {
        ...
        proto: {
            ...
            getInline: function(t, e) {
                if (_(),
                t.src) {
                    var i, n = g.st.inline, o = u(t.src);
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (k || (C = n.hiddenClass,
                    k = d(C),
                    C = "mfp-" + C),
                    S = o.after(k).detach().removeClass(C)),
                    g.updateStatus("ready")) : (g.updateStatus("error", n.tNotFound),
                    o = u("<div>")),
                    t.inlineElement = o
                }
        ...
        proto: {
                ...
                var i = 0
                  ...
                  , o = function(t) {
                    ...
                    M = setInterval(function() {
                        return 0 < n.naturalWidth ? void g._onImageHasSize(e) : (200 < i && clearInterval(M),
            ...
            getImage: function(t, e) {
                var i, n = 0, o = function() {
                    ...
                    t.hasSize = !0,
                    t.loaded = !0,
                    f("ImageLoadComplete")) : ++n < 200 ? setTimeout(o, 100) : r())
                }, r = function() {
                    t && (t.img.off(".mfploader"),
                    t === g.currItem && (g._onImageHasSize(t),
                    g.updateStatus("error", a.tError.replace("%url%", t.src))),
                    t.hasSize = !0,
                    t.loaded = !0,
                    t.loadError = !0)
                }, a = g.st.image, s = e.find(".mfp-img");
                ...
                g.resizeImage(),
                t.hasSize ? (M && clearInterval(M),
                t.loadError ? (e.addClass("mfp-loading"),
                g.updateStatus("error", a.tError.replace("%url%", t.src))) : (e.removeClass("mfp-loading"),
    ...
    u.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                a.enabled && g.supportsTransition && (n = a.duration,
                o = function(t) {
            ...
            _getOffset: function(t) {
                ...
                P ? r["-moz-transform"] = r.transform = "translate(" + i.left + "px," + i.top + "px)" : (r.left = i.left,
                r.top = i.top),
                r
            }
        }
        ...
        proto: {
            initGallery: function() {
                ...
                h("BuildControls" + t, function() {
                    var t, e, i;
                    1 < g.items.length && r.arrows && !g.arrowLeft && (t = r.arrowMarkup,
    ...
    u.magnificPopup.registerModule(N, {
        ...
        proto: {
            initRetina: function() {
                ...
                n = i.ratio,
                1 < (n = isNaN(n) ? n() : n) && (h("ImageHasSize." + N, function(t, e) {
                    e.img.css({
    ...
    function i(c, o, u) {
        ...
        u.fn[c] = function(t) {
            ...
            (e = this).each(function(t, e) {
                ...
                o ? (i = o[r]) && "_" != r.charAt(0) ? (n = i.apply(o, a),
                s = void 0 === s ? n : s) : d(l + " is not a valid method") : d(c + " not initialized. Cannot call methods, i.e. " + l)
            }),
            void 0 !== s ? s : e
        }
        ,
...
function(t, e) {
    ...
    var C, i = "undefined" == typeof console ? function() {}
    : function(t) {
        console.error(t)
    }
    , k = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], S = k.length, T = !1;
    return _
}),
function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    l._transitionTo = function(t, e) {
        this.getPosition();
        var i, n, o, r = this.position.x, a = this.position.y, s = parseInt(t, 10), l = parseInt(e, 10), c = s === this.position.x && l === this.position.y;
        this.setPosition(t, e),
        !c || this.isTransitioning ? (i = t - r,
        n = e - a,
...
function(o, r) {
    ...
    a.create = function(t, e) {
        var i = s(a);
        return i.defaults = r.extend({}, a.defaults),
...
function(t, e) {
    ...
    i._manageStamp = function(t) {
        ...
        for (var s = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, l = r; l <= a; l++)
...
function(a, s) {
    ...
    l._filter = function(t) {
        for (var e = (e = this.options.filter) || "*", i = [], n = [], o = [], r = this._getFilterTest(e), a = 0; a < t.length; a++) {
            var s, l = t[a];
            l.isIgnored || ((s = r(l)) && i.push(l),
            s && l.isHidden ? n.push(l) : s || l.isHidden || o.push(l))
        }
        return {
            matches: i,
            needReveal: n,
    ...
    var h = function(t) {
        if ("string" != typeof t)
            return t;
        var e, i, n = c(t).split(" "), o = n[0], r = o.match(/^\[(.+)\]$/), a = r && r[1], s = (i = o,
        (e = a) ? function(t) {
    ...
    l._sort = function() {
        var t, e, a, s;
        this.options.sortBy && (t = r.makeArray(this.options.sortBy),
        ...
        e = function(t, e) {
            for (var i = 0; i < a.length; i++) {
                var n = a[i]
                  ...
                  , r = e.sortData[n];
                if (r < o || o < r)
                    return (r < o ? 1 : -1) * ((void 0 !== s[n] ? s[n] : s) ? 1 : -1)
            }
            return 0
        }
        ,
    ...
    return function r(a, s, l) {
        ...
        3: [function(t, e, i) {
            ...
            a.prototype.setValues = function(t, e) {
                var i, n = this.values, o = this.spaces, r = this.maxes, a = 1;
                if ("alpha" === t)
                    a = e;
                else if (e.length)
                    ...
                    for (var s = o[t], l = 0; l < t.length; l++)
                        n[t][l] = e[s[l]];
                    a = e.alpha
                }
                if (n.alpha = Math.max(0, Math.min(1, void 0 === a ? n.alpha : a)),
                "alpha" === t)
                    return !1;
                for (l = 0; l < t.length; l++)
                    i = Math.max(0, Math.min(r[t][l], n[t][l])),
                    n[t][l] = Math.round(i);
                for (var c in o)
                    c !== t && (n[c] = u[t][c](n[t]));
                return !0
        ...
        4: [function(t, e, i) {
            function o(t) {
                var e, i, n = t[0] / 255, o = t[1] / 255, r = t[2] / 255, a = Math.min(n, o, r), s = Math.max(n, o, r), l = s - a;
                return s == a ? e = 0 : n == s ? e = (o - r) / l : o == s ? e = 2 + (r - n) / l : r == s && (e = 4 + (n - o) / l),
                (e = Math.min(60 * e, 360)) < 0 && (e += 360),
                i = (a + s) / 2,
                [e, 100 * (s == a ? 0 : i <= .5 ? l / (s + a) : l / (2 - s - a)), 100 * i]
            }
            function n(t) {
                var e, i = t[0], n = t[1], o = t[2], r = Math.min(i, n, o), a = Math.max(i, n, o), s = a - r, l = 0 == a ? 0 : s / a * 1e3 / 10;
                return a == r ? e = 0 : i == a ? e = (n - o) / s : n == a ? e = 2 + (o - i) / s : o == a && (e = 4 + (i - n) / s),
                (e = Math.min(60 * e, 360)) < 0 && (e += 360),
                [e, l, a / 255 * 1e3 / 10]
            }
            function a(t) {
            ...
            function u(t) {
                ...
                [116 * (n = .008856 < n ? Math.pow(n, 1 / 3) : 7.787 * n + 16 / 116) - 16, 500 * (i - n), 200 * (n - (o = .008856 < o ? Math.pow(o, 1 / 3) : 7.787 * o + 16 / 116))]
            }
            function h(t) {
                var e, i, n, o, r, a = t[0] / 360, s = t[1] / 100, l = t[2] / 100;
                if (0 == s)
                    return [r = 255 * l, r, r];
            ...
            function m(t) {
                ...
                return o = .0031308 < o ? 1.055 * Math.pow(o, 1 / 2.4) - .055 : o *= 12.92,
                r = .0031308 < r ? 1.055 * Math.pow(r, 1 / 2.4) - .055 : r *= 12.92,
                a = .0031308 < a ? 1.055 * Math.pow(a, 1 / 2.4) - .055 : a *= 12.92,
            ...
            function y(t) {
                var e, i = t[0], n = t[1], o = t[2], r = i <= 8 ? (e = 100 * i / 903.3) / 100 * 7.787 + 16 / 116 : (e = 100 * Math.pow((i + 16) / 116, 3),
                Math.pow(e / 100, 1 / 3)), a = a / 95.047 <= .008856 ? a = 95.047 * (n / 500 + r - 16 / 116) / 7.787 : 95.047 * Math.pow(n / 500 + r, 3), s = s / 108.883 <= .008859 ? s = 108.883 * (r - o / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(r - o / 200, 3);
                return [a, e, s]
            }
            function x(t) {
                var e = t[0]
                ...
                s.controllers.bar = s.DatasetController.extend({
                    ...
                    calculateBarBase: function(t, e) {
                        ...
                        if (!0 === n.options.stacked || void 0 === n.options.stacked && void 0 !== i.stack) {
                            for (var a = this.chart, s = a.data.datasets, l = Number(s[t].data[e]), c = 0; c < t; c++) {
                                var u, h = s[c], d = a.getDatasetMeta(c);
                                d.bar && d.yAxisID === n.id && a.isDatasetVisible(c) && i.stack === d.stack && (u = Number(h.data[e]),
                                o += l < 0 ? Math.min(u, r) : Math.max(u, r))
                            }
                    ...
                    getStackIndex: function(t) {
                        for (var e, i = this.chart.getDatasetMeta(t), n = this.getScaleForId(i.yAxisID), o = [i.stack], r = 0; r < t; ++r)
                            (e = this.chart.getDatasetMeta(r)).bar && this.chart.isDatasetVisible(r) && (!1 === n.options.stacked || !0 === n.options.stacked && -1 === o.indexOf(e.stack) || void 0 === n.options.stacked && (void 0 === e.stack || -1 === o.indexOf(e.stack))) && o.push(e.stack);
                        return o.length - 1
                    },
                    ...
                    calculateBarY: function(t, e) {
                        ...
                        if (n.options.stacked || void 0 === n.options.stacked && void 0 !== i.stack) {
                            for (var r = n.getBaseValue(), a = r, s = r, l = 0; l < e; l++) {
                                var c, u = this.chart.data.datasets[l], h = this.chart.getDatasetMeta(l);
                    ...
                    draw: function(t) {
                        var e, i, n = t || 1, o = this.getMeta().data, r = this.getDataset();
                        for (s.canvasHelpers.clipArea(this.chart.chart.ctx, this.chart.chartArea),
                        e = 0,
                        i = o.length; e < i; ++e) {
                            var a = r.data[e];
                    ...
                    setHoverStyle: function(t) {
                        var e = this.chart.data.datasets[t._datasetIndex]
                          ...
                          , n = t.custom || {}
                          , o = t._model;
                        o.backgroundColor = n.hoverBackgroundColor ? n.hoverBackgroundColor : d.getValueAtIndexOrDefault(e.hoverBackgroundColor, i, d.getHoverColor(o.backgroundColor)),
                ...
                s.controllers.horizontalBar = s.controllers.bar.extend({
                    ...
                    calculateBarBase: function(t, e) {
                        ...
                        if (n.options.stacked || void 0 === n.options.stacked && void 0 !== i.stack) {
                            for (var a = this.chart, s = a.data.datasets, l = Number(s[t].data[e]), c = 0; c < t; c++) {
                                var u, h = s[c], d = a.getDatasetMeta(c);
                                d.bar && d.xAxisID === n.id && a.isDatasetVisible(c) && i.stack === d.stack && (u = Number(h.data[e]),
                                o += l < 0 ? Math.min(u, r) : Math.max(u, r))
                            }
                            return n.getPixelForValue(o)
                        }
            ...
            e.exports = function(d) {
                ...
                d.controllers.bubble = d.DatasetController.extend({
                    ...
                    updateElement: function(t, e, i) {
                        ...
                        var h = t._model;
                        h.skip = a.skip ? a.skip : isNaN(h.x) || isNaN(h.y),
                        t.pivot()
                    },
        ...
        17: [function(t, e, i) {
            ...
            e.exports = function(e) {
                        ...
                        callbacks: {
                            ...
                            label: function(t, e) {
                                var i = e.labels[t.index]
                                  , n = ": " + e.datasets[t.datasetIndex].data[t.index];
                                return D.isArray(i) ? (i = i.slice())[0] += n : i += n,
                                i
                            }
                        }
                    }
                ...
                e.controllers.doughnut = e.controllers.pie = e.DatasetController.extend({
                    ...
                    update: function(i) {
                        var t, e, n, o, r, a, s, l, c, u, h, d, f, p, g, m, v, y = this, b = y.chart, x = b.chartArea, w = b.options, _ = w.elements.arc, C = x.right - x.left - _.borderWidth, k = x.bottom - x.top - _.borderWidth, S = Math.min(C, k), T = {
                            x: 0,
                            y: 0
                        }, E = y.getMeta(), I = w.cutoutPercentage, A = w.circumference;
                        A < 2 * Math.PI && (t = w.rotation % (2 * Math.PI),
                        ...
                        l = t <= .5 * Math.PI && .5 * Math.PI <= e || t <= 2.5 * Math.PI && 2.5 * Math.PI <= e,
                        c = t <= -Math.PI && -Math.PI <= e || t <= Math.PI && Math.PI <= e,
                        u = t <= .5 * -Math.PI && .5 * -Math.PI <= e || t <= 1.5 * Math.PI && 1.5 * Math.PI <= e,
                        h = I / 100,
                        d = c ? -1 : Math.min(n * (n < 0 ? 1 : h), r * (r < 0 ? 1 : h)),
                        f = u ? -1 : Math.min(o * (o < 0 ? 1 : h), a * (a < 0 ? 1 : h)),
                        m = .5 * ((p = s ? 1 : Math.max(n * (0 < n ? 1 : h), r * (0 < r ? 1 : h))) - d),
                        v = .5 * ((g = l ? 1 : Math.max(o * (0 < o ? 1 : h), a * (0 < a ? 1 : h))) - f),
                        S = Math.min(C / m, k / v),
                        T = {
                            x: -.5 * (p + d),
                            y: -.5 * (g + f)
                    ...
                    updateElement: function(t, e, i) {
                        ...
                        i && a.animateRotate || (m.startAngle = 0 === e ? r.rotation : this.getMeta().data[e - 1]._model.endAngle,
        ...
        18: [function(t, e, i) {
            ...
            e.exports = function(a) {
                ...
                a.controllers.line = a.DatasetController.extend({
                    ...
                    update: function(t) {
                        var e, i, n, o = this.getMeta(), r = o.dataset, a = o.data || [], s = this.chart.options, l = s.elements.line, c = this.getScaleForId(o.yAxisID), u = this.getDataset(), h = d(u, s);
                        for (h && (n = r.custom || {},
                        ...
                        for (h && 0 !== r._model.tension && this.updateBezierControlPoints(),
                        e = 0,
                        i = a.length; e < i; ++e)
                            a[e].pivot()
                    },
                    getPointBackgroundColor: function(t, e) {
                        var i = this.chart.options.elements.point.backgroundColor
                          , n = this.getDataset()
                          , o = t.custom || {};
                        return o.backgroundColor ? i = o.backgroundColor : n.pointBackgroundColor ? i = g.getValueAtIndexOrDefault(n.pointBackgroundColor, e, i) : n.backgroundColor && (i = n.backgroundColor),
                        i
                    },
                    getPointBorderColor: function(t, e) {
                        var i = this.chart.options.elements.point.borderColor
                          , n = this.getDataset()
                          , o = t.custom || {};
                        return o.borderColor ? i = o.borderColor : n.pointBorderColor ? i = g.getValueAtIndexOrDefault(n.pointBorderColor, e, i) : n.borderColor && (i = n.borderColor),
                        i
                    },
                    getPointBorderWidth: function(t, e) {
                        var i = this.chart.options.elements.point.borderWidth
                          , n = this.getDataset()
                          , o = t.custom || {};
                        return isNaN(o.borderWidth) ? isNaN(n.pointBorderWidth) ? isNaN(n.borderWidth) || (i = n.borderWidth) : i = g.getValueAtIndexOrDefault(n.pointBorderWidth, e, i) : i = o.borderWidth,
                        i
                    },
                    updateElement: function(t, e, i) {
                        var n, o, r = this, a = r.getMeta(), s = t.custom || {}, l = r.getDataset(), c = r.index, u = l.data[e], h = r.getScaleForId(a.yAxisID), d = r.getScaleForId(a.xAxisID), f = r.chart.options.elements.point, p = 1 === (r.chart.data.labels || []).length || 1 === l.data.length || r.chart.isCombo;
                    ...
                    calculatePointY: function(t, e, i) {
                        var n, o = this.chart, r = this.getMeta(), a = this.getScaleForId(r.yAxisID), s = 0, l = 0;
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        var e, i, n, o, r = this.getMeta(), a = this.chart.chartArea, s = r.data || [];
                    ...
                    draw: function(t) {
                        for (var e = this.getMeta(), i = e.data || [], n = t || 1, o = 0, r = i.length; o < r; ++o)
                            i[o].transition(n);
                        for (a.canvasHelpers.clipArea(this.chart.chart.ctx, this.chart.chartArea),
            ...
            e.exports = function(e) {
                ...
                e.defaults.polarArea = {
                    ...
                    legend: {
                        ...
                        onClick: function(t, e) {
                            for (var i, n = e.index, o = this.chart, r = 0, a = (o.data.datasets || []).length; r < a; ++r)
                                (i = o.getDatasetMeta(r)).data[n].hidden = !i.data[n].hidden;
                            o.update()
                        }
                    },
                    tooltips: {
                ...
                e.controllers.polarArea = e.DatasetController.extend({
                    ...
                    updateElement: function(t, e, i) {
                        for (var n = this.chart, o = this.getDataset(), r = n.options, a = r.animation, s = n.scale, l = w.getValueAtIndexOrDefault, c = n.data.labels, u = this.calculateCircumference(o.data[e]), h = s.xCenter, d = s.yCenter, f = 0, p = this.getMeta(), g = 0; g < e; ++g)
            ...
            e.exports = function(t) {
                ...
                t.controllers.radar = t.DatasetController.extend({
                    ...
                    setHoverStyle: function(t) {
                        ...
                        o.backgroundColor = i.hoverBackgroundColor ? i.hoverBackgroundColor : c.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, n, c.getHoverColor(o.backgroundColor)),
            ...
            e.exports = function(g) {
                ...
                t.drawPoint = function(t, e, i, n, o) {
                    ...
                    if ("object" != typeof e || "[object HTMLImageElement]" !== (r = e.toString()) && "[object HTMLCanvasElement]" !== r) {
                        if (!(isNaN(i) || i <= 0)) {
                            ...
                            case "rectRounded":
                                var h = i / Math.SQRT2
                                  ...
                                  , f = o - h
                                  , p = Math.SQRT2 * i;
                                g.helpers.drawRoundedRectangle(t, d, f, p, p, i / 2),
                                t.fill();
                                break;
                            case "rectRot":
                                u = 1 / Math.SQRT2 * i,
                        ...
                        t.drawImage(e, n - e.width / 2, o - e.height / 2)
                }
                ,
        ...
        23: [function(t, e, i) {
            ...
            e.exports = function(u) {
                ...
                u.Controller = function(t, e, i) {
                    ...
                    a && s ? (r.initialize(),
                    r.update()) : console.error("Failed to create chart: can't acquire context from the given item"),
                    r
                }
                ,
                h.extend(u.Controller.prototype, {
                    ...
                    clear: function() {
                        return h.clear(this.chart),
                        this
                    },
                    stop: function() {
                        return u.animationService.cancelAnimation(this),
                        this
                    },
                    resize: function(t) {
                        var e, i = this.chart, n = this.options, o = i.canvas, r = n.maintainAspectRatio && i.aspectRatio || null, a = Math.floor(h.getMaximumWidth(o)), s = Math.floor(r ? a / r : h.getMaximumHeight(o));
                        i.width === a && i.height === s || (o.width = i.width = a,
                        o.height = i.height = s,
                        o.style.width = a + "px",
                        o.style.height = s + "px",
                        h.retinaScale(i),
                    ...
                    buildScales: function() {
                        ...
                        h.each(e, function(t) {
                            var e, i = t.options, n = h.getValueOrDefault(i.type, t.dtype), o = u.scaleService.getScaleConstructor(n);
                            o && (e = new o({
                                id: i.id,
                                options: i,
                                ctx: r.chart.ctx,
                    ...
                    buildOrUpdateControllers: function() {
                        ...
                        if (h.each(n.data.datasets, function(t, e) {
                            ...
                            o.push(i.type),
                            i.controller ? i.controller.updateIndex(e) : (i.controller = new u.controllers[i.type](n,e),
                            r.push(i.controller))
                        }, n),
                        1 < o.length)
                    ...
                    update: function(t, e) {
                        ...
                        !1 !== l.notify(r, "beforeUpdate") && (r.tooltip._data = r.data,
                        i = r.buildOrUpdateControllers(),
                        h.each(r.data.datasets, function(t, e) {
                    ...
                    updateLayout: function() {
                        !1 !== l.notify(this, "beforeLayout") && (u.layoutService.update(this, this.chart.width, this.chart.height),
                    ...
                    render: function(t, e) {
                        ...
                        if (!1 !== l.notify(i, "beforeRender")) {
                            var n, o = i.options.animation, r = function() {
                                l.notify(i, "afterRender");
                                var t = o && o.onComplete;
                                t && t.call && t.call(i)
                            };
                            return o && (void 0 !== t && 0 !== t || void 0 === t && 0 !== o.duration) ? ((n = new u.Animation).numSteps = (t || o.duration) / 16.66,
                            n.easing = o.easing,
                            ...
                            u.animationService.addAnimation(i, n, t, e)) : (i.draw(),
                            r()),
                            i
                        }
                    },
                    draw: function(t) {
                        ...
                        e.clear(),
                        null != t || (t = 1),
                        !1 !== l.notify(e, "beforeDraw", [t]) && (h.each(e.boxes, function(t) {
                            t.draw(e.chartArea)
                        }, e),
                    ...
                    getDatasetMeta: function(t) {
                        ...
                        e._meta[this.id] || (e._meta[this.id] = {
                            type: null,
                            data: [],
                            dataset: null,
                            controller: null,
                    ...
                    destroy: function() {
                        var t, e, i, n = this, o = n.chart.canvas;
                        for (n.stop(),
                        e = 0,
                        i = n.data.datasets.length; e < i; ++e)
                            (t = n.getDatasetMeta(e)).controller && (t.controller.destroy(),
                            t.controller = null);
                        o && (n.unbindEvents(),
                        h.clear(n.chart),
                        d.releaseContext(n.chart.ctx),
                        n.chart.canvas = null,
                        n.chart.ctx = null),
                        l.notify(n, "destroy"),
                    ...
                    updateHoverStyle: function(t, e, i) {
                        for (var n, o = i ? "setHoverStyle" : "removeHoverStyle", r = 0, a = t.length; r < a; ++r)
                            (n = t[r]) && this.getDatasetMeta(n._datasetIndex).controller[o](n)
                    },
                    eventHandler: function(t) {
                        ...
                        if (!1 !== l.notify(e, "beforeEvent", [t])) {
                            ...
                            return o ? e.render(o.duration, o.lazy) : n && !e.animating && (e.stop(),
        ...
        24: [function(t, e, i) {
            ...
            e.exports = function(t) {
                function n(e, t) {
                    ...
                    o && (-1 !== (n = (i = o.listeners).indexOf(t)) && i.splice(n, 1),
                ...
                s.extend(t.DatasetController.prototype, {
                    ...
                    addElements: function() {
                        for (var t = this.getMeta(), e = this.getDataset().data || [], i = t.data, n = 0, o = e.length; n < o; ++n)
                    ...
                    buildOrUpdateElements: function() {
                        var o, t, e = this.getDataset(), i = e.data || (e.data = []);
                        this._data !== i && (this._data && n(this._data, this),
                        t = this,
                        (o = i)._chartjs ? o._chartjs.listeners.push(t) : (Object.defineProperty(o, "_chartjs", {
                            configurable: !0,
                            enumerable: !1,
                            value: {
                                listeners: [t]
                    ...
                    update: s.noop,
                    draw: function(t) {
                        for (var e = t || 1, i = this.getMeta().data, n = 0, o = i.length; n < o; ++n)
                            i[n].transition(e).draw()
                    },
        ...
        25: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                a.extend(t.Element.prototype, {
                    ...
                    pivot: function() {
                        return this._view || (this._view = a.clone(this._model)),
                        this._start = a.clone(this._view),
                        this
                    },
                    transition: function(o) {
                        var r = this;
                        return r._view || (r._view = a.clone(r._model)),
                        1 === o ? (r._view = r._model,
                        r._start = null) : (r._start || r.pivot(),
                        a.each(r._model, function(e, i) {
                            if ("_" !== i[0])
                                if (r._view.hasOwnProperty(i)) {
                                    if (e !== r._view[i])
                                        if ("string" == typeof e)
                                            ...
                                            var n;
                                            "number" == typeof e ? (n = void 0 !== r._start[i] && !1 === isNaN(r._start[i]) ? r._start[i] : 0,
                                            r._view[i] = (r._model[i] - n) * o + n) : r._view[i] = e
                                        }
                                } else
                                    "number" != typeof e || isNaN(r._view[i]) ? r._view[i] = e : r._view[i] = e * o
                        }, r)),
                        r
                    },
            ...
            e.exports = function(a) {
                ...
                p.each = function(t, e, i, n) {
                    if (p.isArray(t))
                        ...
                        for (var o = Object.keys(t), r = o.length, a = 0; a < r; a++)
                            e.call(i, t[o[a]], o[a])
                }
                ,
                p.clone = function(t) {
                ...
                p.where = function(t, e) {
                    if (p.isArray(t) && Array.prototype.filter)
                        return t.filter(e);
                    var i = [];
                ...
                p.splineCurveMonotone = function(t) {
                    for (var e, i, n, o, r, a, s, l, c, u = (t || []).map(function(t) {
                        ...
                        (o = u[d]).model.skip || (i = 0 < d ? u[d - 1] : null,
                        (n = d < h - 1 ? u[d + 1] : null) && !n.model.skip && (e = n.model.x - o.model.x,
                        o.deltaK = 0 != e ? (n.model.y - o.model.y) / e : 0),
                    ...
                    for (d = 0; d < h - 1; ++d)
                        o = u[d],
                        n = u[d + 1],
                        o.model.skip || n.model.skip || (p.almostEquals(o.deltaK, 0, this.EPSILON) ? o.mK = n.mK = 0 : (r = o.mK / o.deltaK,
                        a = n.mK / o.deltaK,
                        (l = Math.pow(r, 2) + Math.pow(a, 2)) <= 9 || (s = 3 / Math.sqrt(l),
                        o.mK = r * s * o.deltaK,
                        n.mK = a * s * o.deltaK)));
                    for (d = 0; d < h; ++d)
                        (o = u[d]).model.skip || (i = 0 < d ? u[d - 1] : null,
                ...
                var i = p.easingEffects = {
                    ...
                    easeInOutElastic: function(t) {
                        var e = 1.70158
                          , i = 0
                          , n = 1;
                        return 0 === t ? 0 : 2 == (t /= .5) ? 1 : (i = i || .3 * 1.5 * 1,
                        e = n < Math.abs(1) ? (n = 1,
                        i / 4) : i / (2 * Math.PI) * Math.asin(1 / n),
                        t < 1 ? n * Math.pow(2, 10 * --t) * Math.sin((t - e) * (2 * Math.PI) / i) * -.5 : n * Math.pow(2, -10 * --t) * Math.sin((t - e) * (2 * Math.PI) / i) * .5 + 1)
                    },
                ...
                p.getRelativePosition = function(t, e) {
                    var i = t.originalEvent || t
                      ...
                      , r = i.touches
                      , a = r && 0 < r.length ? (f = r[0].clientX,
                    r[0].clientY) : (f = i.clientX,
                    i.clientY)
                ...
                ,
                p.color = function(t) {
                    return n ? n(t instanceof CanvasGradient ? a.defaults.global.defaultColor : t) : (console.error("Color.js not found!"),
                    t)
                }
                ,
            ...
            e.exports = function(t) {
                ...
                function l(t, e) {
                    for (var i, n, o, r = 0, a = t.data.datasets.length; r < a; ++r)
                        if (t.isDatasetVisible(r))
                            for (n = 0,
                            o = (i = t.getDatasetMeta(r)).data.length; n < o; ++n) {
                                var s = i.data[n];
                                s._view.skip || e(s)
                            }
                }
                ...
                function c(t, n, o, r) {
                    var a = Number.POSITIVE_INFINITY
                      , s = [];
                    return r = r || u.distanceBetweenPoints,
                    l(t, function(t) {
                        var e, i;
                        o && !t.inRange(n.x, n.y) || (e = t.getCenterPoint(),
                        (i = r(n, e)) < a ? (s = [t],
                        a = i) : i === a && s.push(t))
                    }),
                    s
        ...
        28: [function(t, e, i) {
            ...
            e.exports = function() {
                var i = function(t, e) {
                    return this.controller = new i.Controller(t,e,this),
                    this.controller
                };
                return i.defaults = {
                    global: {
            ...
            e.exports = function(t) {
                ...
                t.layoutService = {
                    ...
                    update: function(e, i, t) {
                        ...
                        function o(t) {
                            t.isHorizontal() ? (t.left = t.options.fullWidth ? s : I,
                            t.right = t.options.fullWidth ? i - l : I + w,
                            t.top = N,
                            t.bottom = N + t.height,
                            N = t.bottom) : (t.left = z,
                            t.right = z + t.width,
                        ...
                        e && (a = (r = e.options.layout) ? r.padding : null,
                        u = c = l = s = 0,
                        u = isNaN(a) ? (s = a.left || 0,
                        l = a.right || 0,
                        c = a.top || 0,
                        a.bottom || 0) : c = l = s = a,
                        ...
                        R.each(h.concat(d, f, p), function(t) {
                            ...
                            i ? (e = t.update(t.options.fullWidth ? m : w, x),
                            _ -= e.height) : (e = t.update(b, y),
                            w -= e.width),
                            C.push({
                                horizontal: i,
                                minSize: e,
                        ...
                        R.each(f.concat(p), function(t) {
                            var e;
                            t.getPadding && (e = t.getPadding(),
                            k = Math.max(k, e.left),
                            S = Math.max(S, e.right))
                        }),
                        R.each(h.concat(d), function(t) {
                            var e;
                            t.getPadding && (e = t.getPadding(),
                            T = Math.max(T, e.top),
                            E = Math.max(E, e.bottom))
                        }),
                        I = s,
                        A = l,
                        D = c,
                        ...
                        M += Math.max(E - M, 0),
                        L = t - D - M,
                        (F = i - I - A) === w && L === _ || (R.each(h, function(t) {
                            t.height = L
                        }),
                        R.each(d, function(t) {
                            t.height = L
        ...
        30: [function(t, e, i) {
            ...
            e.exports = function(O) {
                ...
                O.Legend = O.Element.extend({
                    ...
                    beforeFit: t,
                    fit: function() {
                        var n, o, t, r, a, s, l, c, u = this, e = u.options, h = e.labels, i = e.display, d = u.ctx, f = O.defaults.global, p = F.getValueOrDefault, g = p(h.fontSize, f.defaultFontSize), m = p(h.fontStyle, f.defaultFontStyle), v = p(h.fontFamily, f.defaultFontFamily), y = F.fontString(g, m, v), b = u.legendHitBoxes = [], x = u.minSize, w = u.isHorizontal();
                        w ? (x.width = u.maxWidth,
                        x.height = i ? 10 : 0) : (x.width = i ? 10 : 0,
                        x.height = u.maxHeight),
                        i && (d.font = y,
                        w ? (n = u.lineWidths = [0],
                        ...
                        F.each(u.legendItems, function(t, e) {
                            ...
                            n[n.length - 1] + i + h.padding >= u.width && (o += g + h.padding,
                            n[n.length] = u.left),
                            b[e] = {
                                left: 0,
                                top: 0,
                    ...
                    draw: function() {
                        var y, b, t, x, e, i, n, w, _, C, k, S, T = this, E = T.options, I = E.labels, A = O.defaults.global, D = A.elements.line, M = T.width, P = T.lineWidths;
                        E.display && (y = T.ctx,
                        ...
                        F.each(T.legendItems, function(t, e) {
                            var i, n, o, r, a, s, l, c, u, h, d, f, p = y.measureText(t.text).width, g = w + x / 2 + p, m = k.x, v = k.y;
                            C ? M <= m + g && (v = k.y += S,
                            k.line++,
                            m = k.x = T.left + (M - P[k.line]) / 2) : v + S > T.bottom && (m = k.x = m + T.columnWidths[k.line] + I.padding,
                            v = k.y = T.top + I.padding,
                            k.line++),
                            a = m,
                            s = v,
                            l = t,
                            ...
                            E.labels && E.labels.usePointStyle ? (d = a + (h = (u = x * Math.SQRT2 / 2) / Math.SQRT2),
                            f = s + h,
                            O.canvasHelpers.drawPoint(y, l.pointStyle, u, d, f)) : (c || y.strokeRect(a, s, w, x),
                            y.fillRect(a, s, w, x)),
                            y.restore()),
                            _[e].left = m,
                            _[e].top = v,
                ...
                O.plugins.register({
                    ...
                    beforeUpdate: function(t) {
                        var e = t.options.legend;
                        e ? (e = F.configMerge(O.defaults.global.legend, e),
                        t.legend ? t.legend.options = e : i(t, e)) : (O.layoutService.removeBox(t, t.legend),
                        delete t.legend)
                    },
                ...
                s.plugins = {
                    ...
                    notify: function(t, e, i) {
                        for (var n, o, r, a, s = this.descriptors(t), l = s.length, c = 0; c < l; ++c)
                            if ("function" == typeof (a = (o = (n = s[c]).plugin)[e]) && ((r = [t].concat(i || [])).push(n.options),
                            !1 === a.apply(o, r)))
                                return !1;
                        return !0
                    },
                    descriptors: function(t) {
                        ...
                        return this._plugins.concat(i.plugins || []).forEach(function(t) {
                            var e, i;
                            -1 === n.indexOf(t) && (e = t.id,
                            !1 !== (i = a[e]) && (!0 === i && (i = l.clone(r[e])),
                            n.push(t),
                            o.push({
                                plugin: t,
                                options: i || {}
        ...
        32: [function(t, e, i) {
            ...
            e.exports = function(x) {
                ...
                x.Scale = x.Element.extend({
                    ...
                    fit: function() {
                        var t, e, i, n, o, r, a, s, l, c, u = this, h = u.minSize = {
                            width: 0,
                            height: 0
                        }, d = u.options, f = d.ticks, p = d.scaleLabel, g = d.gridLines, m = d.display, v = u.isHorizontal(), y = j(f), b = 1.5 * j(p).size, x = d.gridLines.tickMarkLength;
                        ...
                        f.display && m && (t = W.longestText(u.ctx, y.font, u.ticks, u.longestTextCache),
                        e = W.numberOfLabelLines(u.ticks),
                        i = .5 * y.size,
                        v ? (u.longestLabelWidth = t,
                        ...
                        c = w(u.ctx, l, y.font),
                        0 !== u.labelRotation ? (u.paddingLeft = "bottom" === d.position ? o * s + 3 : o * i + 3,
                        u.paddingRight = "bottom" === d.position ? o * i + 3 : o * c + 3) : (u.paddingLeft = s / 2 + 3,
                        u.paddingRight = c / 2 + 3)) : (f.mirror ? t = 0 : t += u.options.ticks.padding,
                        h.width += t,
                        u.paddingTop = y.size / 2,
                        u.paddingBottom = y.size / 2)),
                        u.handleMargins(),
                        u.width = h.width,
                        u.height = h.height
                    },
                    ...
                    getPixelForTick: function(t, e) {
                        ...
                        if (i.isHorizontal()) {
                            var n = (i.width - (i.paddingLeft + i.paddingRight)) / Math.max(i.ticks.length - (i.options.gridLines.offsetGridLines ? 0 : 1), 1)
                              , o = n * t + i.paddingLeft;
                            return e && (o += n / 2),
                            i.left + Math.round(o) + (i.isFullWidth() ? i.margins.left : 0)
                        }
                    ...
                    draw: function(_) {
                        var C = this
                          , k = C.options;
                        if (k.display) {
                            var S, t, o = C.ctx, e = x.defaults.global, T = k.ticks, E = k.gridLines, i = k.scaleLabel, I = 0 !== C.labelRotation, n = T.autoSkip, A = C.isHorizontal();
                            ...
                            if (A) {
                                if (S = !1,
                                I && (u /= 2),
                                (u + T.autoSkipPadding) * C.ticks.length > C.width - (C.paddingLeft + C.paddingRight) && (S = 1 + Math.floor((u + T.autoSkipPadding) * C.ticks.length / (C.width - (C.paddingLeft + C.paddingRight)))),
                                t && C.ticks.length > t)
                                    for (; !S || C.ticks.length / (S || 1) > t; )
                                        S = S || 1,
                                        S += 1;
                                n || (S = !1)
                            }
                            var h, d, f, p, g, m, v, y, b, F = "right" === k.position ? C.left : C.right - D, z = "right" === k.position ? C.left + D : C.right, N = "bottom" === k.position ? C.top : C.bottom - D, R = "bottom" === k.position ? C.top + D : C.bottom;
                            W.each(C.ticks, function(t, e) {
                                var i, n, o, r, a, s, l, c, u, h, d, f, p, g, m, v, y, b, x, w;
                                null != t && (i = C.ticks.length === e + 1,
                                (1 < S && 0 < e % S || e % S == 0 && e + S >= C.ticks.length) && !i || null == t || (o = e === (void 0 !== C.zeroLineIndex ? C.zeroLineIndex : 0) ? (n = E.zeroLineWidth,
                                E.zeroLineColor) : (n = W.getValueAtIndexOrDefault(E.lineWidth, e),
                                W.getValueAtIndexOrDefault(E.color, e)),
                                u = c = "middle",
                                A ? (l = "bottom" === k.position ? (u = I ? "middle" : "top",
                                c = I ? "right" : "center",
                                C.top + D) : (u = I ? "middle" : "bottom",
                                c = I ? "left" : "center",
                                C.bottom - D),
                                ...
                                g = R,
                                m = _.top,
                                v = _.bottom) : (y = "left" === k.position,
                                b = T.padding,
                                x = T.mirror ? (c = y ? "left" : "right",
                                b) : (c = y ? "right" : "left",
                                D + b),
                            ...
                            W.each(L, function(t) {
                                ...
                                o.beginPath(),
                                E.drawTicks && (o.moveTo(t.tx1, t.ty1),
                                o.lineTo(t.tx2, t.ty2)),
                                E.drawOnChartArea && (o.moveTo(t.x1, t.y1),
                                o.lineTo(t.x2, t.y2)),
                                o.stroke(),
                                o.restore()),
                                T.display) {
                            ...
                            i.display && (p = 0,
                            A ? (d = C.left + (C.right - C.left) / 2,
                            f = "bottom" === k.position ? C.bottom - l.size / 2 : C.top + l.size / 2) : (d = (h = "left" === k.position) ? C.left + l.size / 2 : C.right - l.size / 2,
                            f = C.top + (C.bottom - C.top) / 2,
                            p = h ? -.5 * Math.PI : .5 * Math.PI),
                            o.save(),
                            o.translate(d, f),
                            o.rotate(p),
                            o.textAlign = "center",
                            ...
                            o.restore()),
                            E.drawBorder && (o.lineWidth = W.getValueAtIndexOrDefault(E.lineWidth, 0),
                            ...
                            A ? (v = y = "top" === k.position ? C.bottom : C.top,
                            v += b,
                            y += b) : (g = m = "left" === k.position ? C.right : C.left,
                            g += b,
                            m += b),
                            o.beginPath(),
                            o.moveTo(g, v),
            ...
            e.exports = function(t) {
                ...
                t.Ticks = {
                    generators: {
                        linear: function(t, e) {
                            var i, n, o = [];
                            n = t.stepSize && 0 < t.stepSize ? t.stepSize : (i = u.niceNum(e.max - e.min, !1),
                            u.niceNum(i / (t.maxTicks - 1), !0));
                            var r = Math.floor(e.min / n) * n
                              , a = Math.ceil(e.max / n) * n;
                            t.min && t.max && t.stepSize && u.almostWhole((t.max - t.min) / t.stepSize, n / 1e3) && (r = t.min,
                            a = t.max);
                            var s = (a - r) / n
                            ...
                            for (var l = 1; l < s; ++l)
                                o.push(r + l * n);
                            return o.push(void 0 !== t.max ? t.max : a),
                            o
                        },
                        logarithmic: function(t, e) {
                            var i, n, o = [], r = u.getValueOrDefault, a = r(t.min, Math.pow(10, Math.floor(u.log10(e.min)))), s = Math.floor(u.log10(e.max)), l = Math.ceil(e.max / Math.pow(10, s));
                            for (0 === a ? (i = Math.floor(u.log10(e.minNotZero)),
                            n = Math.floor(e.minNotZero / Math.pow(10, i)),
                            o.push(a),
                            a = n * Math.pow(10, i)) : (i = Math.floor(u.log10(a)),
                            n = Math.floor(a / Math.pow(10, i))); o.push(a),
                            10 === ++n && (n = 1,
                            ++i),
                            a = n * Math.pow(10, i),
                            i < s || i === s && n < l; )
        ...
        35: [function(t, e, i) {
            ...
            e.exports = function(m) {
                ...
                m.Title = m.Element.extend({
                    ...
                    fit: function() {
                        var t = v.getValueOrDefault
                          ...
                          , r = this.minSize;
                        this.isHorizontal() ? (r.width = this.maxWidth,
                        r.height = n ? o + 2 * e.padding : 0) : (r.width = n ? o + 2 * e.padding : 0,
                    ...
                    draw: function() {
                        var t, e, i, n, o, r, a, s, l, c, u, h, d = this.ctx, f = v.getValueOrDefault, p = this.options, g = m.defaults.global;
                        ...
                        d.font = a,
                        this.isHorizontal() ? (t = c + (h - c) / 2,
                        e = l + (u - l) / 2,
                        i = h - c) : (t = "left" === p.position ? c + n / 2 : h - n / 2,
                        e = l + (u - l) / 2,
                        i = u - l,
                        s = Math.PI * ("left" === p.position ? -.5 : .5)),
                        d.save(),
                        d.translate(t, e),
                        d.rotate(s),
                        d.textAlign = "center",
                ...
                m.plugins.register({
                    ...
                    beforeUpdate: function(t) {
                        var e = t.options.title;
                        e ? (e = v.configMerge(m.defaults.global.title, e),
                        t.titleBlock ? t.titleBlock.options = e : i(t, e)) : (m.layoutService.removeBox(t, t.titleBlock),
                        delete t.titleBlock)
                    }
                })
            }
        ...
        36: [function(t, e, i) {
            ...
            e.exports = function(O) {
                ...
                function a(t, e) {
                    return e && (N.isArray(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
                    t
                }
                function L(t) {
                ...
                function F(t, e) {
                    ...
                    var f = 0;
                    return i.font = N.fontString(c, e._titleFontStyle, e._titleFontFamily),
                    N.each(e.title, d),
                ...
                function z(t, e) {
                    ...
                    var u, h = (o.left + o.right) / 2, d = (o.top + o.bottom) / 2, f = "center" === a ? (u = function(t) {
                        return t <= h
                    }
                    ,
                    function(t) {
                ...
                O.defaults.global.tooltips = {
                    ...
                    callbacks: {
                        beforeTitle: N.noop,
                        title: function(t, e) {
                            var i, n = "", o = e.labels, r = o ? o.length : 0;
                            return 0 < t.length && ((i = t[0]).xLabel ? n = i.xLabel : 0 < r && i.index < r && (n = o[i.index])),
                            n
                        },
                        afterTitle: N.noop,
                        beforeBody: N.noop,
                ...
                O.Tooltip = O.Element.extend({
                    ...
                    update: function(t) {
                        var e, i, n, o, r, a, s, l, c, u, h, d, f, p, g, m, v, y = this, b = y._options, x = y._model, w = y._model = L(b), _ = y._active, C = y._data, k = y._chartInstance, S = {
                            xAlign: x.xAlign,
                            yAlign: x.yAlign
                        }, T = {
                            x: x.x,
                    ...
                    drawCaret: function(t, e, i) {
                        var n, o, r, a, s, l = this._view, c = this._chart.ctx, u = l.caretSize, h = l.cornerRadius, d = l.xAlign, f = l.yAlign, p = t.x, g = t.y, m = e.width, v = e.height, y = "center" === f ? (r = (o = "left" === d ? (n = p) - u : (n = p + m) + u,
                        n),
                        a = (s = g + v / 2) - u,
                        s + u) : (r = "left" === d ? (o = (n = p + h) + u) + u : "right" === d ? (o = (n = p + m - h) - u) - u : (n = (o = p + m / 2) - u,
                        o + u),
                        s = "top" === f ? (a = g) - u : (a = g + v) + u,
                        a);
                        c.fillStyle = b(l.backgroundColor, i),
                        c.beginPath(),
                        c.moveTo(n, a),
                        c.lineTo(o, s),
                        c.lineTo(r, y),
                    ...
                    drawTitle: function(t, e, i, n) {
                        ...
                        if (o.length) {
                            ...
                            i.textBaseline = "top";
                            var r, a, s = e.titleFontSize, l = e.titleSpacing;
                            for (i.fillStyle = b(e.titleFontColor, n),
                            i.font = N.fontString(s, e._titleFontStyle, e._titleFontFamily),
                            r = 0,
                            a = o.length; r < a; ++r)
                                i.fillText(o[r], t.x, t.y),
                                t.y += s + l,
                                r + 1 === o.length && (t.y += e.titleMarginBottom - l)
                        }
                    },
                    drawBody: function(i, n, o, r) {
                        var a = n.bodyFontSize
                          , e = n.bodySpacing
                          , t = n.body;
                        o.textAlign = n._bodyAlign,
                        o.textBaseline = "top";
                        var s = b(n.bodyFontColor, r);
                        o.fillStyle = s,
                        o.font = N.fontString(a, n._bodyFontStyle, n._bodyFontFamily);
                        function l(t) {
                            o.fillText(t, i.x + c, i.y),
                            i.y += a + e
                        }
                        var c = 0;
                        ...
                        N.each(t, function(t, e) {
                            ...
                            N.each(t.lines, function(t) {
                                u && (o.fillStyle = b(n.legendColorBackground, r),
                    ...
                    drawFooter: function(e, i, n, t) {
                        var o = i.footer;
                        o.length && (e.y += i.footerMarginTop,
                    ...
                    drawBackground: function(t, e, i, n, o) {
                        ...
                        N.drawRoundedRectangle(i, t.x, t.y, n.width, n.height, e.cornerRadius),
                        i.fill()
                    },
                    draw: function() {
                        var t, e, i, n = this._chart.ctx, o = this._view;
                        0 !== o.opacity && (t = {
                            width: o.width,
                            height: o.height
                        },
                        ...
                        i = Math.abs(o.opacity < .001) ? 0 : o.opacity,
                        this._options.enabled && (this.drawBackground(e, o, n, t, i),
                    ...
                    handleEvent: function(t) {
                        ...
                        i.update(!0),
                        i.pivot(),
                        o |= e.x !== i._model.x || e.y !== i._model.y),
                        o
                    }
                }),
                O.Tooltip.positioners = {
                    average: function(t) {
                        ...
                        for (var e = 0, i = 0, n = 0, o = 0, r = t.length; o < r; ++o) {
                            var a, s = t[o];
                            s && s.hasValue() && (e += (a = s.tooltipPosition()).x,
                            i += a.y,
                            ++n)
                        }
                        return {
                    ...
                    nearest: function(t, e) {
                        for (var i, n, o = e.x, r = e.y, a = Number.POSITIVE_INFINITY, s = 0, l = t.length; s < l; ++s) {
                            var c, u, h = t[s];
                            h && h.hasValue() && (c = h.getCenterPoint(),
                            (u = N.distanceBetweenPoints(e, c)) < a && (a = u,
                            i = h))
                        }
                        return i && (o = (n = i.tooltipPosition()).x,
                        r = n.y),
                        {
                            x: o,
                            y: r
                    ...
                    inRange: function(t, e) {
                        ...
                        if (i) {
                            for (var n = u.getAngleFromPoint(i, {
                                x: t,
                                y: e
                            }), o = n.angle, r = n.distance, a = i.startAngle, s = i.endAngle; s < a; )
                                s += 2 * Math.PI;
                            for (; s < o; )
                                o -= 2 * Math.PI;
                            for (; o < a; )
            ...
            e.exports = function(t) {
                ...
                t.elements.Line = t.Element.extend({
                    draw: function() {
                        function t(t, e) {
                            var i = e._view;
                            !0 === e._view.steppedLine ? (r.lineTo(i.x, t._view.y),
                            r.lineTo(i.x, i.y)) : 0 === e._view.tension ? r.lineTo(i.x, i.y) : r.bezierCurveTo(t._view.controlPointNextX, t._view.controlPointNextY, i.controlPointPreviousX, i.controlPointPreviousY, i.x, i.y)
                        }
                        var e = this._view
                          , i = e.spanGaps
                          , n = e.scaleZero
                        ...
                        r.save();
                        var a, s, l, c, u = this._children.slice(), h = -1;
                        if (o && u.length && u.push(u[0]),
                        u.length && e.fill) {
                            for (r.beginPath(),
                            a = 0; a < u.length; ++a)
                                s = u[a],
                                ...
                                c = s._view,
                                0 === a ? (o ? r.moveTo(n.x, n.y) : r.moveTo(c.x, n),
                                c.skip || (h = a,
                                r.lineTo(c.x, c.y))) : (l = -1 === h ? l : u[h],
                                c.skip ? i || h !== a - 1 || (o ? r.lineTo(n.x, n.y) : r.lineTo(l._view.x, n)) : (h === a - 1 || i && -1 !== h ? t(l, s) : (o || r.lineTo(c.x, n),
                                r.lineTo(c.x, c.y)),
                                h = a));
                            o || -1 === h || r.lineTo(u[h]._view.x, n),
                            r.fillStyle = e.backgroundColor || p.defaultColor,
                            r.closePath(),
                            r.fill()
                        }
                        var d = p.elements.line;
                        for (r.lineCap = e.borderCapStyle || d.borderCapStyle,
                        ...
                        a = 0; a < u.length; ++a)
                            ...
                            l = f.previousItem(u, a),
                            c = s._view,
                            0 === a ? c.skip || (r.moveTo(c.x, c.y),
                            h = a) : (l = -1 === h ? l : u[h],
                            c.skip || (h !== a - 1 && !i || -1 === h ? r.moveTo(c.x, c.y) : t(l, s),
                            h = a));
                        r.stroke(),
                        r.restore()
                    }
                ...
                u.elements.Point = u.Element.extend({
                    ...
                    draw: function(t) {
                        var e = this._view
                          ...
                          , l = u.helpers.color
                          , c = 0;
                        e.skip || (n.strokeStyle = e.borderColor || f,
                        n.lineWidth = h.getValueOrDefault(e.borderWidth, d.elements.point.borderWidth),
                        n.fillStyle = e.backgroundColor || f,
                        void 0 !== t && (i.x < t.left || 1.01 * t.right < i.x || i.y < t.top || 1.01 * t.bottom < i.y) && (i.x < t.left ? c = (a - i.x) / (t.left - i.x) : 1.01 * t.right < i.x ? c = (i.x - a) / (i.x - t.right) : i.y < t.top ? c = (s - i.y) / (t.top - i.y) : 1.01 * t.bottom < i.y && (c = (i.y - s) / (i.y - t.bottom)),
        ...
        40: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                function o(t) {
                    ...
                    return r = l(t) ? (e = s.width / 2,
                    i = s.x - e,
                    n = s.x + e,
                    o = Math.min(s.y, s.base),
                    Math.max(s.y, s.base)) : (a = s.height / 2,
                    i = Math.min(s.x, s.base),
                    n = Math.max(s.x, s.base),
                    o = s.y - a,
                    s.y + a),
                    {
                        left: i,
                ...
                t.elements.Rectangle = t.Element.extend({
                    draw: function() {
                        ...
                        var e, i, n, o, r, a, s, l, c, u, h, d, f = this._chart.ctx, p = this._view, g = p.borderWidth, m = p.horizontal ? (e = p.base,
                        i = p.x,
                        n = p.y - p.height / 2,
                        o = p.y + p.height / 2,
                        r = e < i ? 1 : -1,
                        a = 1,
                        p.borderSkipped || "left") : (e = p.x - p.width / 2,
                        i = p.x + p.width / 2,
                        r = 1,
                        a = (n = p.y) < (o = p.base) ? 1 : -1,
                        p.borderSkipped || "bottom");
                        g && (l = (g = (s = Math.min(Math.abs(e - i), Math.abs(n - o))) < g ? s : g) / 2,
                        h = n + ("top" !== m ? l * a : 0),
                        d = o + ("bottom" !== m ? -l * a : 0),
                        (c = e + ("left" !== m ? l * r : 0)) !== (u = i + ("right" !== m ? -l * r : 0)) && (n = h,
                        o = d),
                        h !== d && (e = c,
                        i = u)),
                        f.beginPath(),
                    ...
                    inRange: function(t, e) {
                        var i, n = !1;
                        return this._view && (n = t >= (i = o(this)).left && t <= i.right && e >= i.top && e <= i.bottom),
                        n
                    },
                    ...
                    getCenterPoint: function() {
                        var t, e = this._view, i = l(this) ? (t = e.x,
                        (e.y + e.base) / 2) : (t = (e.x + e.base) / 2,
                        e.y);
                        return {
                            x: t,
                            y: i
        ...
        41: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                function o(t, e, i) {
                    ...
                    o.style.cssText = "display:block;overflow:hidden;border:0;margin:0;top:0;left:0;bottom:0;right:0;height:100%;width:100%;position:absolute;pointer-events:none;z-index:-1;",
                    o.tabIndex = -1,
                    l.addEvent(o, "load", function() {
                        l.addEvent(o.contentWindow || o, "resize", n),
                        n()
                    }),
                    o),
                ...
                return {
                    acquireContext: function(t, e) {
                        ...
                        t instanceof HTMLCanvasElement) {
                            ...
                            if (i instanceof CanvasRenderingContext2D)
                                ...
                                null !== l && "" !== l || ("" === n.style.height ? n.height = n.width / (o.options.aspectRatio || 2) : (a = u(n, "height"),
                                void 0 !== r && (n.height = a))),
                                i
                        }
                        var n, o, r, a, s, l, c;
                    ...
                    releaseContext: function(t) {
                        var i, n = t.canvas;
                        n._chartjs && (i = n._chartjs.initial,
                    ...
                    removeEventListener: function(t, e, i) {
                        ...
                        "resize" !== e ? (r = ((i._chartjs || {}).proxies || {})[t.id + "_" + e]) && l.removeEvent(a, e, r) : (n = a.parentNode) && n._chartjs && ((o = n._chartjs.resizer) && (o.parentNode.removeChild(o),
                        n._chartjs.resizer = null),
                        delete n._chartjs)
                    }
                }
            }
                ...
                var n = t.helpers
                  , e = t.Scale.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        void 0 !== e.options.ticks.min && (t = n.indexOf(i, e.options.ticks.min),
                        e.minIndex = -1 !== t ? t : e.minIndex),
                        void 0 !== e.options.ticks.max && (t = n.indexOf(i, e.options.ticks.max),
                    ...
                    getPixelForValue: function(t, e, i, n) {
                        ...
                        if (void 0 !== t && isNaN(e) && (e = -1 !== (o = r.getLabels().indexOf(t)) ? o : e),
                        r.isHorizontal()) {
                            var s = r.width / a
                              , l = s * (e - r.minIndex);
                            return (r.options.gridLines.offsetGridLines && n || r.maxIndex === r.minIndex && n) && (l += s / 2),
                            r.left + Math.round(l)
                        }
                        var c = r.height / a
                          , u = c * (e - r.minIndex);
                        return r.options.gridLines.offsetGridLines && n && (u += c / 2),
                        r.top + Math.round(u)
                    },
                    getPixelForTick: function(t, e) {
                ...
                var h = i.helpers
                  ...
                  , e = i.LinearScaleBase.extend({
                    determineDataLimits: function() {
                        ...
                        h.each(t, function(t, e) {
                            ...
                            c.isDatasetVisible(e) && a(n) && h.each(t.data, function(t, e) {
                                ...
                                isNaN(i) || n.data[e].hidden || (o[e] = o[e] || 0,
                                r[e] = r[e] || 0,
                                l.relativePoints ? o[e] = 100 : i < 0 ? r[e] += i : o[e] += i)
                            })
                        }),
                        h.each(u, function(t) {
                            var e = t.positiveValues.concat(t.negativeValues)
                              , i = h.min(e)
                              , n = h.max(e);
                            s.min = null === s.min ? i : Math.min(s.min, i),
                            s.max = null === s.max ? n : Math.max(s.max, n)
                        })) : h.each(t, function(t, e) {
                            var n = c.getDatasetMeta(e);
                            c.isDatasetVisible(e) && a(n) && h.each(t.data, function(t, e) {
                                var i = +s.getRightValue(t);
                                isNaN(i) || n.data[e].hidden || ((null === s.min || i < s.min) && (s.min = i),
                    ...
                    getTickLimit: function() {
                        ...
                        return this.isHorizontal() ? Math.min(e.maxTicksLimit ? e.maxTicksLimit : 11, Math.ceil(this.width / 50)) : (t = h.getValueOrDefault(e.fontSize, i.defaults.global.defaultFontSize),
            ...
            e.exports = function(r) {
                ...
                r.LinearScaleBase = r.Scale.extend({
                    handleTickRangeOptions: function() {
                        var t, e, i = this, n = i.options.ticks;
                        n.beginAtZero && (t = a.sign(i.min),
                        e = a.sign(i.max),
                        t < 0 && e < 0 ? i.max = 0 : 0 < t && 0 < e && (i.min = 0)),
                  ...
                  , e = o.Scale.extend({
                    determineDataLimits: function() {
                        ...
                        h.each(e, function(t, e) {
                            ...
                            c.isDatasetVisible(e) && a(o) && (void 0 === u[r] && (u[r] = []),
                            h.each(t.data, function(t, e) {
                                var i = u[r]
                                  , n = +s.getRightValue(t);
                                isNaN(n) || o.data[e].hidden || (i[e] = i[e] || 0,
                                l.relativePoints ? i[e] = 100 : i[e] += n)
                            }))
                        }),
                        h.each(u, function(t) {
                            var e = h.min(t)
                              , i = h.max(t);
                            s.min = null === s.min ? e : Math.min(s.min, e),
                            s.max = null === s.max ? i : Math.max(s.max, i)
                        })) : h.each(e, function(t, e) {
                            var n = c.getDatasetMeta(e);
                            c.isDatasetVisible(e) && a(n) && h.each(t.data, function(t, e) {
                                var i = +s.getRightValue(t);
                        ...
                        s.min = i(t.min, s.min),
                        s.max = i(t.max, s.max),
                        s.min === s.max && (0 !== s.min && null !== s.min ? (s.min = Math.pow(10, Math.floor(h.log10(s.min)) - 1),
                        s.max = Math.pow(10, Math.floor(h.log10(s.max)) + 1)) : (s.min = 1,
                        s.max = 10))
                    },
                    buildTicks: function() {
                        var t = this
                    ...
                    getPixelForValue: function(t) {
                        var e, i, n = this, o = n.start, r = +n.getRightValue(t), a = n.options.ticks, s = n.isHorizontal() ? (i = h.log10(n.end) - h.log10(o),
                        0 == r ? n.left : (e = n.width,
                        n.left + e / i * (h.log10(r) - h.log10(o)))) : (e = n.height,
                        0 !== o || a.reverse ? 0 === n.end && a.reverse ? (i = h.log10(n.start) - h.log10(n.minNotZero),
                        r === n.end ? n.top : r === n.minNotZero ? n.top + .02 * e : n.top + .02 * e + .98 * e / i * (h.log10(r) - h.log10(n.minNotZero))) : (i = h.log10(n.end) - h.log10(o),
                        e = n.height,
                        n.bottom - e / i * (h.log10(r) - h.log10(o))) : (i = h.log10(n.end) - h.log10(n.minNotZero),
                        r === o ? n.bottom : r === n.minNotZero ? n.bottom - .02 * e : n.bottom - .02 * e - .98 * e / i * (h.log10(r) - h.log10(n.minNotZero))));
                        return s
                    },
                    getValueForPixel: function(t) {
                        var e, i = h.log10(this.end) - h.log10(this.start), n = this.isHorizontal() ? (e = this.width,
                        this.start * Math.pow(10, (t - this.left) * i / e)) : (e = this.height,
                        Math.pow(10, (this.bottom - t) * i / e) / this.start);
                        return n
                    }
                });
        ...
        47: [function(t, e, i) {
            ...
            e.exports = function(t) {
                ...
                function x(t, e, i, n) {
                    if (w.isArray(e))
                        for (var o = i.y, r = 1.5 * n, a = 0; a < e.length; ++a)
                  ...
                  , i = t.LinearScaleBase.extend({
                    ...
                    determineDataLimits: function() {
                        ...
                        w.each(i.data.datasets, function(t, e) {
                            var n;
                            i.isDatasetVisible(e) && (n = i.getDatasetMeta(e),
                            w.each(t.data, function(t, e) {
                                var i = +o.getRightValue(t);
                                isNaN(i) || n.data[e].hidden || (r = Math.min(i, r),
                                a = Math.max(i, a))
                            }))
                        }),
                    ...
                    fit: function() {
                        var t, e;
                        this.options.lineArc ? (t = this,
                        e = Math.min(t.height / 2, t.width / 2),
                        t.drawingArea = Math.round(e),
                        t.setCenterPoint(0, 0, 0, 0)) : function(t) {
                            var e, i, n = b(t), o = Math.min(t.height / 2, t.width / 2), r = {
                                l: t.width,
                                r: 0,
                                t: t.height,
                                b: 0
                    ...
                    setReductions: function(t, e, i) {
                        var n = e.l / Math.sin(i.l)
                          ...
                          , r = s(r)
                          , a = s(a);
                        this.drawingArea = Math.min(Math.round(t - (n + o) / 2), Math.round(t - (r + a) / 2)),
                        this.setCenterPoint(n, o, r, a)
                    },
                    setCenterPoint: function(t, e, i, n) {
                        ...
                        o.xCenter = Math.round((a + r) / 2 + o.left),
                    ...
                    draw: function() {
                        var a, s, t, e, l, c = this, u = c.options, h = u.gridLines, d = u.ticks, f = w.getValueOrDefault;
                        u.display && (a = c.ctx,
                        ...
                        w.each(c.ticks, function(t, e) {
                            var i, n, o, r;
                            (0 < e || u.reverse) && (i = c.getDistanceFromCenterForValue(c.ticksAsNumbers[e]),
                            n = c.yCenter - i,
                            h.display && 0 !== e && function(t, e, i, n) {
                                var o = t.ctx;
                                if (o.strokeStyle = w.getValueAtIndexOrDefault(e.color, n - 1),
                                o.lineWidth = w.getValueAtIndexOrDefault(e.lineWidth, n - 1),
                                t.options.lineArc)
                                    o.beginPath(),
                                    ...
                                    o.moveTo(a.x, a.y);
                                    for (var s = 1; s < r; s++)
                                        a = t.getPointPosition(s, i),
                                        o.lineTo(a.x, a.y);
                                    o.closePath(),
                                    o.stroke()
                                }
                            }(c, h, i, e),
                            d.display && (o = f(d.fontColor, _.defaultFontColor),
                            a.font = l,
                            d.showLabelBackdrop && (r = a.measureText(t).width,
                        ...
                        u.lineArc || function(t) {
                            ...
                            for (var l, c, u, h, d, f = y(t) - 1; 0 <= f; f--) {
                                o.display && (l = t.getPointPosition(f, a),
                                e.beginPath(),
                ...
                var b = y.helpers
                  ...
                  , t = y.Scale.extend({
                    ...
                    getLabelDiff: function(t, e) {
                        return null === t || null === e ? null : (void 0 === this.labelDiffs && this.buildLabelDiffs(),
                        void 0 !== this.labelDiffs[t] ? this.labelDiffs[t][e] : null)
                    },
                    ...
                    determineDataLimits: function() {
                        ...
                        o.chart.data.labels && 0 < o.chart.data.labels.length ? (b.each(o.chart.data.labels, function(t) {
                            var e = o.parseTime(t);
                            e.isValid() && (o.options.time.round && e.startOf(o.options.time.round),
                            r.push(e))
                        }, o),
                        o.firstTick = a.min.call(o, r),
                        o.lastTick = a.max.call(o, r)) : (o.firstTick = null,
                        o.lastTick = null),
                        b.each(o.chart.data.datasets, function(t, e) {
                            var i = []
                            ...
                            "object" == typeof t.data[0] && null !== t.data[0] ? b.each(t.data, function(t) {
                                ...
                                e.isValid() && (o.options.time.round && e.startOf(o.options.time.round),
                                i.push(e),
                                n && (o.firstTick = null !== o.firstTick ? a.min(o.firstTick, e) : e,
                                o.lastTick = null !== o.lastTick ? a.max(o.lastTick, e) : e))
                            }, o) : i = r,
                    ...
                    buildLabelDiffs: function() {
                        ...
                        n.chart.data.labels && 0 < n.chart.data.labels.length && b.each(n.chart.data.labels, function(t) {
                            var e = n.parseTime(t);
                            e.isValid() && (n.options.time.round && e.startOf(n.options.time.round),
                            o.push(e.diff(n.firstTick, n.tickUnit, !0)))
                        }, n),
                        b.each(n.chart.data.datasets, function(t) {
                            var i = [];
                            "object" == typeof t.data[0] && null !== t.data[0] ? b.each(t.data, function(t) {
                                var e = n.parseTime(n.getRightValue(t));
                                e.isValid() && (n.options.time.round && e.startOf(n.options.time.round),
                                i.push(e.diff(n.firstTick, n.tickUnit, !0)))
                            }, n) : i = o,
                            n.labelDiffs.push(i)
                        }, n)
                    },
                    buildTicks: function() {
                        ...
                        t.options.time.unit)
                            ...
                            for (var l = 0, c = x.units[l]; l < x.units.length; ) {
                                if (t.unitScale = 1,
                                b.isArray(c.steps) && Math.ceil(t.scaleSizeInUnits / s) < b.max(c.steps)) {
                                ...
                                t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0) + h + d,
                                t.displayFormat = t.options.time.displayFormats[c.name]
                            }
                        }
                        var f, p, g = t.options.time.min ? t.getMomentStartOf(t.firstTick) : (t.firstTick = t.getMomentStartOf(t.firstTick),
                        t.firstTick);
                        t.options.time.max || ((p = (f = t.getMomentStartOf(t.lastTick)).diff(t.lastTick, t.tickUnit, !0)) < 0 ? t.lastTick = t.getMomentStartOf(t.lastTick.add(1, t.tickUnit)) : 0 <= p && (t.lastTick = f),
                        t.scaleSizeInUnits = t.lastTick.diff(t.firstTick, t.tickUnit, !0)),
                        ...
                        for (var m = t.unitScale; m <= t.scaleSizeInUnits; m += t.unitScale) {
                            ...
                            if (t.options.time.max && 0 <= v.diff(t.lastTick, t.tickUnit, !0))
                                break;
                            t.ticks.push(v)
                        }
                    ...
                    getLabelForIndex: function(t, e) {
                        ...
                        return null !== n && "object" == typeof n && (i = this.getRightValue(n)),
                    ...
                    getPixelForValue: function(t, e, i) {
                        var n = this
                          , o = null;
                        if (void 0 !== e && void 0 !== i && (o = n.getLabelDiff(i, e)),
                        null === o && (t && t.isValid || (t = n.parseTime(n.getRightValue(t))),
                        t && t.isValid && t.isValid() && (o = t.diff(n.firstTick, n.tickUnit, !0))),
                        null !== o) {
                    ...
                    getValueForPixel: function(t) {
                        ...
                        return i *= this.scaleSizeInUnits,
                        this.firstTick.clone().add(a.duration(i, this.tickUnit).asSeconds(), "seconds")
                    },
                    parseTime: function(t) {
                        ...
                        this.options.time.format(t)) : a(t, this.options.time.format)
                    }
                });
...
function(n) {
    ...
    var e = function(t) {
        ...
        this._handlers = {
            "prepared.owl.carousel": n.proxy(function(t) {
                var e;
                !t.namespace || !this.owl.options.thumbs || this.owl.options.thumbImage || this.owl.options.thumbsPrerendered || this.owl.options.thumbImage ? t.namespace && this.owl.options.thumbs && this.owl.options.thumbImage && (e = n(t.content).find("img"),
                this._thumbcontent.push(e)) : void 0 !== n(t.content).find("[data-thumb]").attr("data-thumb") && this._thumbcontent.push(n(t.content).find("[data-thumb]").attr("data-thumb"))
            }, this),
            "initialized.owl.carousel": n.proxy(function(t) {
    ...
    e.prototype.listen = function() {
        ...
        n(this._thumbcontent._thumbcontainer).on("click", this._thumbcontent._thumbcontainer.children(), n.proxy(function(t) {
    ...
    e.prototype.render = function() {
        ...
        if (e.thumbsPrerendered ? (this._thumbcontent._thumbcontainer = n("." + e.thumbContainerClass),
        e.moveThumbsInside && this._thumbcontent._thumbcontainer.appendTo(this.$element)) : this._thumbcontent._thumbcontainer = n("<div>").addClass(e.thumbContainerClass).appendTo(this.$element),
        e.thumbImage)
            for (t = 0; t < this._thumbcontent.length; ++t)
                this._thumbcontent._thumbcontainer.append("<button class=" + e.thumbItemClass + '><img src="' + this._thumbcontent[t].attr("src") + '" alt="' + this._thumbcontent[t].attr("alt") + '" /></button>');
        else
            for (t = 0; t < this._thumbcontent.length; ++t)
                this._thumbcontent._thumbcontainer.append("<button class=" + e.thumbItemClass + ">" + this._thumbcontent[t] + "</button>")
    }
    ,
    e.prototype.setActive = function() {
        ...
        e.children().filter(".active").removeClass("active"),
        e.children().eq(this.owl_currentitem).addClass("active")
    }
    ,
    e.prototype.destroy = function() {
        var t, e;
...
jQuery(document).ready(function(a) {
    ...
    function f(t) {
        var e, i, n = m(t);
        t.parents(".cd-headline").hasClass("type") ? ((e = t.parent(".cd-words-wrapper")).addClass("selected").removeClass("waiting"),
        setTimeout(function() {
        ...
        setTimeout(function() {
            p(n, r)
        }, h)) : t.parents(".cd-headline").hasClass("letters") ? (i = t.children("i").length >= n.children("i").length,
        function t(e, i, n, o) {
            ...
            {
                var r;
                e.is(":last-child") && a("html").hasClass("no-csstransitions") && (r = m(i),
                v(i, r))
            }
        }(t.find("i").eq(0), t, i, o),
        g(n.find("i").eq(0), n, i, o)) : t.parents(".cd-headline").hasClass("clip") ? t.parents(".cd-words-wrapper").animate({
            width: "2px"
        }, d, function() {
            v(t, n),
            p(n)
    ...
    function p(t, e) {
        t.parents(".cd-headline").hasClass("type") ? (g(t.find("i").eq(0), t, !1, e),
        t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".cd-headline").hasClass("clip") && t.parents(".cd-words-wrapper").animate({
            width: t.width() + 10
        }, d, function() {
            setTimeout(function() {
                f(t)
    ...
    function g(t, e, i, n) {
        ...
        t.is(":last-child") ? (e.parents(".cd-headline").hasClass("type") && setTimeout(function() {
    ...
    function(t) {
        ...
        t.each(function() {
            ...
            o.hasClass("loading-bar") ? (r = l,
            setTimeout(function() {
                o.find(".cd-words-wrapper").addClass("is-loading")
            }, c)) : o.hasClass("clip") ? (e = (t = o.find(".cd-words-wrapper")).width() + 10,
            t.css("width", e)) : o.hasClass("type") || (i = o.find(".cd-words-wrapper b"),
            n = 0,
            i.each(function() {
                var t = a(this).width();
                n < t && (n = t)
...
function(t, e) {
    ...
    , function(t, e) {
        t.exports = function(t) {
            var e, i, n, o = "SELECT" === t.nodeName ? (t.focus(),
    ...
    , function(t, e, i) {
        ...
        t.exports = function(t, e, i, n, o) {
            return "function" == typeof t.addEventListener ? r.apply(null, arguments) : "function" == typeof i ? r.bind(null, document).apply(null, arguments) : ("string" == typeof t && (t = document.querySelectorAll(t)),
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(c) {
      ...
      , M = {
        ...
        util: {
            ...
            clone: function i(t, n) {
                ...
                case "Object":
                    ...
                    n[e] = o,
                    t)
                        t.hasOwnProperty(a) && (o[a] = i(t[a], n));
                    return o;
                case "Array":
                    return e = M.util.objId(t),
                    n[e] ? n[e] : (o = [],
                    n[e] = o,
                    t.forEach(function(t, e) {
                        o[e] = i(t, n)
        ...
        languages: {
            ...
            DFS: function t(e, i, n, o) {
                ...
                for (var l in e) {
                    e.hasOwnProperty(l) && (i.call(e, l, e[l], n || l),
                    r = e[l],
                    "Object" !== (a = M.util.type(r)) || o[s(r)] ? "Array" !== a || o[s(r)] || (o[s(r)] = !0,
                    t(r, i, l, o)) : (o[s(r)] = !0,
                    t(r, i, null, o)))
                }
            }
        ...
        highlightAllUnder: function(t, e, i) {
            ...
            for (var o, r = n.elements || t.querySelectorAll(n.selector), a = 0; o = r[a++]; )
                M.highlightElement(o, !0 === e, n.callback)
        },
        highlightElement: function(t, e, i) {
            for (var n, o = "none", r = t; r && !u.test(r.className); )
                r = r.parentNode;
            r && (o = (r.className.match(u) || [, "none"])[1].toLowerCase(),
            n = M.languages[o]),
            t.className = t.className.replace(u, "").replace(/\s+/g, " ") + " language-" + o,
            t.parentNode && (r = t.parentNode,
            /pre/i.test(r.nodeName) && (r.className = r.className.replace(u, "").replace(/\s+/g, " ") + " language-" + o));
            function a(t) {
                l.highlightedCode = t,
            ...
            l.code ? (M.hooks.run("before-highlight", l),
            l.grammar ? e && c.Worker ? ((s = new Worker(M.filename)).onmessage = function(t) {
                a(t.data)
            }
            ,
        ...
        highlight: function(t, e, i) {
            ...
            return M.hooks.run("before-tokenize", n),
            n.tokens = M.tokenize(n.code, n.grammar),
            M.hooks.run("after-tokenize", n),
            P.stringify(M.util.encode(n.tokens), n.language)
        },
            ...
            for (var s in i)
                if (i.hasOwnProperty(s) && i[s]) {
                    ...
                    for (var l = i[s], l = "Array" === M.util.type(l) ? l : [l], c = 0; c < l.length; ++c) {
                        var u, h = l[c], d = h.inside, f = !!h.lookbehind, p = !!h.greedy, g = 0, m = h.alias;
                        p && !h.pattern.global && (u = h.pattern.toString().match(/[imuy]*$/)[0],
                        h.pattern = RegExp(h.pattern.source, u + "g")),
                        h = h.pattern || h;
                        for (var v = n, y = o; v < e.length; y += e[v].length,
                        ++v) {
                            var b = e[v];
                            ...
                            if (!(b instanceof P)) {
                                if (p && v != e.length - 1) {
                                    ...
                                    !(S = h.exec(t)))
                                        break;
                                    for (var x = S.index + (f ? S[1].length : 0), w = S.index + S[0].length, _ = v, C = y, k = e.length; _ < k && (C < w || !e[_].type && !e[_ - 1].greedy); ++_)
                                        (C += e[_].length) <= x && (++v,
                                        y = C);
                                    if (e[v]instanceof P)
                                        continue;
                                ...
                                if (S) {
                                    f && (g = S[1] ? S[1].length : 0),
                                    w = (x = S.index + g) + (S = S[0].slice(g)).length;
                                    var E = b.slice(0, x)
                                      , I = b.slice(w)
                                      , A = [v, T];
                                    E && (++v,
                                    ...
                                    1 != T && M.matchGrammar(t, e, i, v, y, !0, s),
                                    r)
                                        break
                                } else if (r)
                                    break
        ...
        tokenize: function(t, e) {
            ...
            return M.matchGrammar(t, i, e, 0, 0, !1),
            i
        },
        hooks: {
            all: {},
    ...
    P.stringify = function(t, e) {
        ...
        t.alias && (i = Array.isArray(t.alias) ? t.alias : [t.alias],
    ...
    ,
    !c.document)
        return c.addEventListener && (M.disableWorkerMessageHandler || c.addEventListener("message", function(t) {
            var e = JSON.parse(t.data)
              , i = e.language
              , n = e.code
              , o = e.immediateClose;
            c.postMessage(M.highlight(n, M.languages[i], i)),
            o && c.close()
        }, !1)),
        M;
    var t = document.currentScript || [].slice.call(document.getElementsByTagName("script")).pop();
    return t && (M.filename = t.src,
    M.manual || t.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(M.highlightAll) : window.setTimeout(M.highlightAll, 16) : document.addEventListener("DOMContentLoaded", M.highlightAll))),
    M
}(_self);
...
function(e) {
    ...
    e(".switcher-setting").on("click", function() {
        e("#style-switcher").hasClass("active") ? e("#style-switcher").removeClass("active") : (e("#style-switcher").removeClass("active"),
        e("#style-switcher").addClass("active"))
    }),
    e(".boxed,.pattren-wrap a").on("click", function() {
        e(".main-wrapper").addClass("wrapper-boxed"),
        e(".main-wrapper").removeClass("wrapper-wide"),
        e(window).resize()
    }),
    e(".wide").on("click", function() {
        e(".main-wrapper").addClass("wrapper-wide"),
        e(".main-wrapper").removeClass("wrapper-boxed"),
        e(window).resize()
    }),
    e(".bg-list li a").on("click", function() {
        var t = e(this).css("backgroundImage");
        e("body").css("backgroundImage", t),
        e(window).resize()
    }),
    e(".style1").on("click", function() {
        return e("#colors").attr("href", "css/styles.css"),
        ...
        e(window).on("scroll", function() {
            ...
            t.attr("src", "img/logos/logo-color-01.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style2").on("click", function() {
        return e("#colors").attr("href", "css/styles-2.css"),
        e("#logo").attr("src", "img/logos/logo-color-02.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-02.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style3").on("click", function() {
        return e("#colors").attr("href", "css/styles-3.css"),
        e("#logo").attr("src", "img/logos/logo-color-03.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-03.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style4").on("click", function() {
        return e("#colors").attr("href", "css/styles-4.css"),
        e("#logo").attr("src", "img/logos/logo-color-04.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-04.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style5").on("click", function() {
        return e("#colors").attr("href", "css/styles-5.css"),
        e("#logo").attr("src", "img/logos/logo-color-05.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-05.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style6").on("click", function() {
        return e("#colors").attr("href", "css/styles-6.css"),
        e("#logo").attr("src", "img/logos/logo-color-06.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-06.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style7").on("click", function() {
        return e("#colors").attr("href", "css/styles-7.css"),
        e("#logo").attr("src", "img/logos/logo-color-07.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-07.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    }),
    e(".style8").on("click", function() {
        return e("#colors").attr("href", "css/styles-8.css"),
        e("#logo").attr("src", "img/logos/logo-color-08.png"),
        e(".header-style6 #logo").attr("src", "img/logos/logo-white.png"),
        e(window).on("scroll", function() {
            e(window).scrollTop();
            var t = e(".navbar-brand img");
            t.attr("src", "img/logos/logo-color-08.png"),
            e(".header-style6 #logo").attr("src", "img/logos/logo-white.png")
        }),
        !1
    })
